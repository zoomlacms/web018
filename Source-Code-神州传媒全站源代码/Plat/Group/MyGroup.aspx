<%@ page language="C#" autoeventwireup="true" inherits="Plat_Group_MyGroup, App_Web_ngs3iuli" masterpagefile="~/Plat/Main.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <ol class="breadcrumb">
        ...
        <li><a title="会员中心" href="/Plat/Blog/">企业系统</a></li>
    ...
    <div>
        <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EnableTheming="False" IsHoldState="false"
            ...
            <Columns>
                ...
                <asp:BoundField HeaderText="组名" DataField="GroupName"/>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <a href="javascript:;">成员详情</a>
                       |<a href="javascript:;" onclick="return confirm('确定要退出该组吗!!');">退出群组</a>
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <table class="table table-bordered">
                           <tr><td>父组：</td><td>
                                <asp:DropDownList runat="server" ID="PGroup_DP" EnableViewState="false" DataTextField="GroupName" DataValueField="ID"></asp:DropDownList>
                               </td></tr>
                           <tr><td>组名：</td><td><asp:TextBox runat="server" ID="GroupName_T" CssClass="form-control" />
                               <asp:RequiredFieldValidator runat="server" ID="Valid1" ControlToValidate="GroupName_T" ValidationGroup="add" ErrorMessage="组名不能为空" ForeColor="Red"/>
                                           </td></tr>
                           <tr><td>描述：</td><td><asp:TextBox runat="server" ID="GroupDesc_T" CssClass="form-control" /></td></tr>
                           <tr><td>管理员：</td><td>
                               <input type="text" id="ManageIDS_T" class="form-control"/><input type="button" value="选择" onclick="selRuser();" class="btn btn-primary" style="margin-left:5px;" />
                               <asp:HiddenField runat="server" ID="ManageIDS_Hid" />
                                             </td></tr>
                           <tr><td>组成员：</td><td>
                               <input type="text" id="MemberIDS_T" class="form-control"/><input type="button" value="选择" onclick="selCuser();" class="btn btn-primary" style="margin-left:5px;"/>
