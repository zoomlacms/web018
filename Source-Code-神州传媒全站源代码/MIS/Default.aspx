<%@ page language="C#" autoeventwireup="true" inherits="MIS_Default, App_Web_ejxx4u4s" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
...
<div id="header" style="position:inherit;">
    ...
    <li><a href="javascript:ShowMain1('0','/user/Usertalk/TalkIndex.aspx');" id="hd0" ><img src="/App_Themes/UserThem/images/Mis/j_ico_comm.png" alt="沟通" /><br />沟通</a></li>
    ...
    <li><a href="javascript:ShowMain1('4','/Mis/Plan/');" id="hd4"><img src="/App_Themes/UserThem/images/Mis/j_ico_plan.png" alt="计划" /><br />计划</a></li>
    <li><a href="javascript:ShowMain1('5','/Mis/Task/');" id="hd5"><img src="/App_Themes/UserThem/images/Mis/j_ico_task.png" alt="任务" /><br />任务</a></li>
    <li><a href="javascript:ShowMain1('6','/Mis/Project/');" id="hd6"><img src="/App_Themes/UserThem/images/Mis/j_ico_project.png" alt="项目" /><br />项目</a></li>
