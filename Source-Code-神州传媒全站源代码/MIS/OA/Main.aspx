<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_Main, App_Web_ft2ie1b0" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                        ...
                        <div class="content templatelist">
                            <div class="inContent executive">
                                <table class="myTable threeTr">
                                    ...
                                    <tr>
                                        <td colspan="3" style="text-align: right;"><a href="#">Mossre...</a></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                    ...
                    <div class="OAborder">
                        ...
                        <div class="content templatelist">
                            <div class="inContent notice">
                                <table class="myTable">
                                    <tr class="hover_hander">
                                        <td><a href="ContentManage.aspx?NodeID=<%=ZoomLa.Components.OAConfig.GetNodeID("党办")%>">
                                            <img src="Images/Main/Party.gif" /></a></td>
                                        <td><a href="ContentManage.aspx?NodeID=<%=ZoomLa.Components.OAConfig.GetNodeID("院办")%>">
                                            <img src="Images/Main/hospital.gif" /></a></td>
                                        <td><a href="ContentManage.aspx?NodeID=<%=ZoomLa.Components.OAConfig.GetNodeID("纪检")%>">
                                            <img src="Images/Main/Discipline.gif" /></a></td>
                                        <td><a href="ContentManage.aspx?NodeID=<%=ZoomLa.Components.OAConfig.GetNodeID("人事")%>">
                                            <img src="Images/Main/affairs.gif" /></a></td>
                                        <td><a href="ContentManage.aspx?NodeID=<%=ZoomLa.Components.OAConfig.GetNodeID("财务")%>">
                                            <img src="Images/Main/Finance.gif" /></a></td>
                                    </tr>
                                    <tr class="hover_hander">
                                        <td><a href="ContentManage.aspx?NodeID=<%=ZoomLa.Components.OAConfig.GetNodeID("科教")%>">
                                            <img src="Images/Main/Science.gif" /></a></td>
                                        <td><a href="ContentManage.aspx?NodeID=<%=ZoomLa.Components.OAConfig.GetNodeID("医务")%>">
                                            <img src="Images/Main/Medical.gif" /></a></td>
                                        <td><a href="ContentManage.aspx?NodeID=<%=ZoomLa.Components.OAConfig.GetNodeID("护理")%>">
                                            <img src="Images/Main/Nurse.gif" /></a></td>
                                        <td><a href="ContentManage.aspx?NodeID=<%=ZoomLa.Components.OAConfig.GetNodeID("信息")%>">
                    ...
                    <div class="OAborder">
                        ...
                        <div class="content templatelist">
                            <div class="inContent">
                                ...
                                <div class="more"><a href="/Class_<%= ZoomLa.Components.OAConfig.GetNodeID("医院最新通知") %>/Default.aspx" target="_blank">More...</a></div>
                            </div>
                        </div>
                    </div>
                </li>
                    ...
                    <div class="OAborder">
                        ...
                        <div class="content templatelist">
                            <div class="inContent">
                                ...
                                <div class="more"><a href="/Class_<%= ZoomLa.Components.OAConfig.GetNodeID("医院论坛交流") %>/Default.aspx" target="_blank">More...</a></div>
                            </div>
                        </div>
                    </div>
                </li>
