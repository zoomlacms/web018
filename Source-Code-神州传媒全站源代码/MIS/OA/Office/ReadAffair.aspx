<%@ page language="C#" autoeventwireup="true" inherits="MIS_ZLOA_Office_ReadAffair, App_Web_mbvsyrsj" clientidmode="Static" validaterequest="false" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
        ...
        <div id="main" style="margin:5px 0 0 0;">
            <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10"  EnableTheming="False"  GridLines="None"   Width="100%" CssClass="table_li table-border" OnPageIndexChanging="EGV_PageIndexChanging" OnRowCommand="EGV_RowCommand" >
               ...
               <%--     <asp:BoundField HeaderText="步骤序号" DataField="ProLevel" HeaderStyle-Width="8%"/>--%>
                    ...
                    <asp:TemplateField HeaderText="处理结果" HeaderStyle-Width="10%">
                        <ItemTemplate>
                           <%#GetResult(Eval("Result")) %>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:BoundField HeaderText="处理人" DataField="UserName" HeaderStyle-Width="15%" />
