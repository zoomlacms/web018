<%@ page language="C#" autoeventwireup="true" inherits="MIS_OA_Mail_SelGroup, App_Web_yqwa0dm3" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <form id="form1" runat="server">
                ...
                <ContentTemplate>
                    <div style="float: left; margin-left: 10px; width: 600px; top: 2px;">
                        <div style="margin-bottom: 5px;">
                            ...
                            <%-- <input type="text" id="keyText" onkeydown="return GetEnterCode('click','keyBtn');" />--%>
                            <%-- <input type="button" id="keyBtn" value="搜索" class="btn-primary" onclick="Search();" />--%>
                            <%-- <input type="button" value="显示全部" class="btn-primary" onclick="ShowAllTr();" />--%>
        ...
        <script>
            ...
            $().ready(function () {
                ...
                //}
                //a('keyText', '请输入用户名或会员组名');
            });
                //function ReBind(id,s)
                //{
                //    $("#"+id).focus(function () { if (this.value == s) { this.value = ''; this.style.color = '#555'; } })
                //        .blur(function () { if (this.value == '') { this.value = s; this.style.color = '#999'; } });
                //}
                //根据会员组筛选
