<%@ page language="C#" autoeventwireup="true" inherits="MIS_MisPunch, App_Web_ejxx4u4s" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
    ...
    <div class="CardBody" style="overflow:hidden;padding-top:10px;">
       ...
       <div class="Cright">
           <table border="0" style="width: 538px">
               <tr class="TrAtt">
                   <td class="TBeginTime">上班 :<asp:Label ID="lblBegin" runat="server"></asp:Label></td>
                   <td class="TBTimes">
               ...
               <tr class="TrAtt">
                   <td class="TEndTime">下班 :<asp:Label ID="lblEnd" runat="server"></asp:Label></td>
                   <td class="TBTimes">
                       <span style="float:left;">
               ...
               <tr class="TrAtt">
                   ...
                   <td class="TxtCommbody">
                       <input type="hidden" id="HidIDs" runat="server" />
                       <div id="EditBtn">
                       <asp:Label ID="lblComm" runat="server"></asp:Label>&nbsp;<a href="#" onclick="ShowDiv()">编辑</a>
                       </div>
                       <div id="EditTxt" style="display:none;">
                           ...
                           <asp:Button ID="BtnSub" runat="server" OnClick="BtnSub_Click" Text="确定"/>&nbsp;<asp:Button ID="BtnClose" runat="server" Text="取消" OnClientClick="return ShowDivs('EditTxt','EditBtn')" />
                       </div>
                   </td>
               </tr>
           </table>
