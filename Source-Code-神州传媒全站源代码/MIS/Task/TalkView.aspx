<%@ page language="C#" autoeventwireup="true" inherits="MIS_Task_TaskInfoView, App_Web_lk2xbhfo" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html> 
<html>
<head runat="server">
...
<ItemTemplate>
    ...
    <td  >
        ...
        <img width=48 height=48 src="<%#getFace(Eval("Inputer").ToString()) %> "/>
        </div>
        <div class="cb"></div>
        <div class="pers_mess">
