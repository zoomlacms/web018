<%@ page language="C#" autoeventwireup="true" inherits="MIS_MisSignSet, App_Web_ejxx4u4s" enableEventValidation="false" viewStateEncryptionMode="Never" %>
           ...
           <asp:Repeater ID="repSign" runat="server">
               <ItemTemplate>
                  <tr class="TrShows">
                      ...
                      <td class="Play">
                      <a href="MisSignSetInfo.aspx?ID=<%#Eval("ID")%>">修改</a>
                      </td>
                  </tr>
               </ItemTemplate>
           </asp:Repeater>
