<%@ page language="C#" autoeventwireup="true" inherits="MIS_AddMis, App_Web_ejxx4u4s" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
  ...
  <form id="form1" runat="server">
     ...
     <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
      ...
      <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td>
          <asp:RadioButtonList ID="TextStatus" runat="server" RepeatDirection="Horizontal" AutoPostBack="True">
        ...
        <td>
            <asp:RadioButtonList ID="TextType" runat="server" RepeatDirection="Horizontal" AutoPostBack="True">
        ...
        <td><asp:TextBox ID="TextJoiner" class="M_input" runat="server" />
          </td>
      </tr>
          <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
