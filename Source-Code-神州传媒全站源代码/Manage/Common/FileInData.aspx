<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Common.FileInData, App_Web_fsxgmpjl" enableviewstatemac="false" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
  ...
  <table style="height: 100%; border: 0; width: 100%">
    <tr class="tdbg">
      <td valign="top" align="left">  <div id="divFile" runat="server"><asp:LinkButton ID="lbtn1" runat="server" Text="文件下载" OnClick="lbtn1_Click"></asp:LinkButton> 
          <a href='/manage/Common/FileInData.aspx?Showtype=<%= Request["Showtype"]%>&ModelID=<%= Request["ModelID"]%>&FieldName=<%= Request["FieldName"]%>&NodeId=<%= Request["NodeId"]%>&re=1'> 重新上传</a></div>  <asp:Label ID="LblMessage" runat="server" ForeColor="red" Text=""></asp:Label>
