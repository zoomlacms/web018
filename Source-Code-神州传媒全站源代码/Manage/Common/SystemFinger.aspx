<%@ page language="C#" autoeventwireup="true" inherits="manage_Common_SystemFinger, App_Web_05iacf2u" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>系统指针</title> 
 ...
 <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
  ...
  <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
     ...
     <br />
<input type="button" name="GetExc" value="保存信息为Excel" id="GetExc" class="C_input" onclick="GetExcel('systb');" />
