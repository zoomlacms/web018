<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_RecyclerNodeTree, App_Web_h5mbsos1" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head id="Head1" runat="server">
    <title><%=lang.Get("m_RecyclerNodeTree_nav")%></title>
    ...
    <ul>
        <li id="Guide_top">
            <div id="Guide_toptext">
                <%=lang.Get("m_RecyclerNodeTree_mall")%></div>
        </li>
        <li id="Guide_main">
