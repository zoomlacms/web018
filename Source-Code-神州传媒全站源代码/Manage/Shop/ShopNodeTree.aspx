<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.ShopNodeTree, App_Web_uchgradw" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>

<html>
<head id="Head1" runat="server">
<title><%=lang.Get("m_ShopNodeTree_nav")%></title>
...
<ul>
    <li id="Guide_top">
        <div id="Guide_toptext"><%=lang.Get("m_ShopNodeTree_mall")%></div>
    </li>
    <li>
        <div id="Guide_div">
