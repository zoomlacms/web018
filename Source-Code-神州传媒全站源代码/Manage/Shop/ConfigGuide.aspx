<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.ConfigGuide, App_Web_0e0gt1da" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div id="Guide_box">
    ...
    <ul>                        
        ...
        <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="FreePost.aspx" target="main_right"><%= lang.Get("m_ConfigGuide_freepost") %></a></li>
