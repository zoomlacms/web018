<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.TotalSale, App_Web_0e0gt1da" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <asp:TextBox ID="toptime" runat="server" class="l_input" Width="109px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd' });" />
            &nbsp;
        至
        <asp:TextBox ID="endtime" runat="server" class="l_input" Width="109px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd' });" />&nbsp;
