<%@ page language="C#" autoeventwireup="true" inherits="Zoomla.Website.manage.Shop.OrderLink, App_Web_uchgradw" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<div id="Div1">
    <ul>
        ...
        <li id="Guide_main">
            <div id="Div2">
                <div class="guideexpand" onclick="Switch(this)"><%=lang.Get("m_OrderLink_orders")%></div>                    
                <div class="guide">
                <ul>                        
                    ...
                    <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="OrderSql.aspx" target="main_right"><%=lang.Get("m_OrderLink_ApplyReceipt")%></a></li>
        ...
        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
            ...
            <div id="Guide_box">
                <div class="guideexpand" onclick="Switch(this)">
                    <%=lang.Get("m_OrderLink_BusinessAnalyse")%>
                </div>                    
                <div class="guide">
                <ul>                        
                    <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="LocationReport.aspx" target="main_right"><%=lang.Get("m_OrderLink_LocationReport")%></a></li>
                    <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="MonthlyReport.aspx" target="main_right"><%=lang.Get("m_OrderLink_MonthReport")%></a></li>
