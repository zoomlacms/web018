<%@ page language="C#" autoeventwireup="true" inherits="manage_ZoneStyleManage_StoreStyleManage, App_Web_0tfzajrd" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        <tr>
            <td width="3%" class="text-center">
                <input id="Checkall" type="checkbox" onclick="javascript: CheckAll(this);" /></td>
