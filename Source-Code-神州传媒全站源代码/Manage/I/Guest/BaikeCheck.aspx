<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Guest_BaikeCheck, App_Web_tn5tq5w3" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<table width="100%" cellspacing="1" cellpadding="0" class="table table-striped table-bordered table-hover" align="center">
    ...
    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
        ...
        <td style="width: 300px"><asp:DropDownList runat="server" ID="classification" CssClass="form-control" Width="150"></asp:DropDownList></td>
    </tr>
