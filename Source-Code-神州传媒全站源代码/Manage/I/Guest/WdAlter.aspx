<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="manage_Guest_WdAlter, App_Web_tn5tq5w3" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div id="main" class="rg_inout">
        <div style="width:500px;margin:auto;">
            <div class="panel panel-primary">
                ...
                <div class="panel-heading">您的问题</div>
            ...
            <div class="panel panel-primary">
                <!-- Default panel contents -->
                <div class="panel-heading">补充问题</div>
                <div class="panel-body">
                    ...
                    <div style="margin-top:10px;">
                        <span style="color: #3171af; float: left;">分类：
                        ...
                        <span style="float: right; color: #3171af;">悬赏分：
