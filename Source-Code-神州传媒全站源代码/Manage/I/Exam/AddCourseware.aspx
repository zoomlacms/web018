<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_AddCourseware, App_Web_0rh0brsi" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <tbody id="Tabs0">
            ...
            <tr>
                ...
                <td class="bqright">
                    ...
                    <input type="button" value="选择主讲人 " class="btn btn-primary" style="width: 100px;" onclick="Openwin(); void (0)" />
                </td>
            </tr>
            <tr>
                <td class="tdbgleft" style="width: 20%" align="right">
