<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="manage_Question_AddQuestion, App_Web_0rh0brsi" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody id="Tabs0">
            ...
            <tr>
                ...
                <td class="bqright">
                    <div style="width: auto; float: left">
                        <asp:RadioButtonList ID="rblDiff" runat="server" RepeatDirection="Horizontal" CssClass="form-control" Height="22px">
            ...
            <tr>
                ...
                <td class="bqright">
                    <asp:TextBox ID="txtP_Content" runat="server" class="form-control" TextMode="MultiLine"
