<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="manage_Question_AddExamExroom, App_Web_0rh0brsi" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" viewStateEncryptionMode="Never" %>
        ...
        <tbody id="Tabs0">
            ...
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td class="bqright">
                    ...
                    <asp:Button ID="Button2" runat="server" Text="选择试卷" CssClass="btn btn-primary" OnClientClick="open_Paper();return false;" />
                </td>
            </tr>
            <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                <td class="tdbgleft" style="width: 20%" align="right">
