<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Scence, App_Web_vbiyigka" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="head">
    ...
    <style type="text/css">
        ...
        /*#AllTable tr {min-width:370px;width:100%;}*/
    </style>
                    ...
                    <tr>
                        <td style="height: 422px" valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="height: 24px; background-color: #2177c2; font-size: 14px; font-weight: bold; color: #FFF">&nbsp;第一步：选择场景
                                    </td>
                                </tr>
                                <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size: 12px">
                    <tr>
                        <td style="height: 422px" valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size: 12px">
                                <tr>
                                    <td style="height: 24px; background-color: #2177c2; font-size: 14px; font-weight: bold; color: #FFF">&nbsp;第二步：场景配置<span id="ScanName"></span>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height: 24px">
                                                ...
                                                <tr>
                                                    <td style="height: 24px; font-size: 12px">&nbsp;
                                                       <div class="checkDiv">会员管理<input id="su1" name="sUser" type="checkbox" checked="checked" /></div>
                                                        ...
                                                        <div class="checkDiv">用户角色<input id="su4" name="sUser" type="checkbox" checked="checked" /></div>
                                                        <div class="checkDiv">信息发送<input id="su5" name="sUser" type="checkbox" checked="checked" /></div>
                                                        <div class="checkDiv">订阅中心<input id="su6" name="sUser" type="checkbox" checked="checked" /></div>
                                                        <div class="checkDiv">人才招聘<input id="su7" name="sUser" type="checkbox" checked="checked" /></div>
                                                        <div class="checkDiv">社区模块<input id="su8" name="sUser" type="checkbox" checked="checked" /></div>
                                                        <div class="checkDiv">视频面试<input id="su9" name="sUser" type="checkbox" checked="checked" /></div>
                                                        <div class="checkDiv">多人视频<input id="su10" name="sUser" type="checkbox" checked="checked" /></div>
