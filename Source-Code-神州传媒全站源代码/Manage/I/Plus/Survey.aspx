<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.Survey, App_Web_42fizwvp" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td><asp:CheckBox ID="ChkNeedLogin" runat="server" Checked="true" />是</td>
        </tr>
        <tr>
            <td><strong>是否启用：</strong></td>
            <td><asp:CheckBox ID="ChkIsOpen" runat="server" Checked="true" />是</td>
        </tr>
        <tr>
