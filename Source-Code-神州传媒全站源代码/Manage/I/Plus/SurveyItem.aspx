<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.SurveyItem, App_Web_42fizwvp" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td colspan="2" class="text-center">
                ...
                <asp:Button ID="btnReturn" runat="server" Text="返回" CssClass="btn btn-primary" OnClick="Button_Click" CommandName="Return" CausesValidation="false" />
            </td>
        </tr>
    </table>
</asp:Content>
