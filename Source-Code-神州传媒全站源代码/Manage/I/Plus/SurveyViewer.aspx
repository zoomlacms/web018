<%@ page language="C#" autoeventwireup="true" inherits="manage_Plus_SurveyViewer, App_Web_42fizwvp" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head">
    <title>问卷来源分析</title>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <asp:GridView ID="gviewSurSorcer" DataKeyNames="Rid" CellPadding="2" CellSpacing="1" CssClass="table table-striped table-bordered table-hover" GridLines="None" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="10" Width="100%" OnRowDataBound="gviewSurSorcer_RowDataBound" OnPageIndexChanging="gviewSurSorcer_PageIndexChanging" OnRowCommand="gviewSurSorcer_RowCommand">
