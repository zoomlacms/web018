<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_EditNode, App_Web_icecyxml" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" cellpadding="2" cellspacing="1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtNodeName" OnTextChanged="TxtNodeName_TextChanged" Style="max-width: 200px;" CssClass="form-control pull-left" AutoPostBack="true" runat="server"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtNodeDir" CssClass="form-control pull-left" Style="max-width: 200px;" OnTextChanged="TxtNodeDir_TextChanged" MaxLength="20" runat="server" AutoPostBack="true" Enabled="false"></asp:TextBox>
                            <asp:Button ID="Button6" CssClass="btn btn-primary" Style="margin-left: 5px;" runat="server" Text="修改" OnClick="Button6_Click" />
