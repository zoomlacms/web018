<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_HitsList, App_Web_ycgjkfed" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="Server">
    <div style="margin-left: 30px; float: left; margin-bottom: 10px;">
        <span class="pull-left" style="line-height: 32px;"><%=lang.Get("M_HitsList_title")%>： </span>
        <asp:TextBox ID="txtTitle" ToolTip="支持模糊查询" runat="server" Width="100px" CssClass="form-control pull-left"></asp:TextBox>
        <span class="pull-left" style="line-height: 32px; margin-left: 5px;"><%=lang.Get("M_HitsList_month")%>：</span>
