<%@ page language="C#" autoeventwireup="true" inherits="V_Content_AddContent, App_Web_mygm4ddm" masterpagefile="~/Manage/I/Default.master" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <div class="tab-pane active" id="ConInfo">
                <table id="mainTable" class="table table-bordered table_padding0">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTitle" style="max-width:715px;background:url(/Images/bg1.gif) repeat-x;" CssClass="form-control pull-left" onkeyup="isgoEmpty('txtTitle','span_txtTitle');query('txtTitle','PYtitle')" runat="server"></asp:TextBox>
                    ...
                    <tr>
                        <td align="right"><asp:Label ID="py" runat="server" Text="拼音"></asp:Label>&nbsp;&nbsp;</td>
                        <td>
