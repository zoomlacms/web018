<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_AddNode, App_Web_ycgjkfed" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            function EBtnS() {
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtNodeName" class="form-control" style="max-width:200px;" runat="server" Columns="30" onkeyup="Getpy('TxtNodeName','TxtNodeDir')"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtNodeDir" class="form-control pull-left" style="max-width:200px;" MaxLength="20" runat="server" Columns="20" OnTextChanged="TxtNodeDir_TextChanged1" AutoPostBack="True"></asp:TextBox>
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" cellpadding="2" cellspacing="1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="UrlLook" style="max-width:200px;" class="form-control pull-left" runat="server"></asp:TextBox>
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" cellpadding="2" cellspacing="1">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <asp:GridView ID="Egv" CssClass="table table-striped table-bordered table-hover" runat="server" AutoGenerateColumns="False" DataKeyNames="RoleID"
                                Width="100%">
                                <Columns>
