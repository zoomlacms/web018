<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_AddModelField, App_Web_mygm4ddm" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    <ol class="breadcrumb">
        ...
        <li>
            <a href="ModelManage.aspx?ModelType=<%=Request.QueryString["ModelType"] %>"><%=bll.GetModelType(Convert.ToInt32(Request.QueryString["ModelType"]))%></a>
        </li>
        <li>
            <a href="ModelField.aspx?ModelId=<%=Request.QueryString["ModelID"] %>&ModelType=<%=Request.QueryString["ModelType"] %>">字段列表</a>
        </li>
        <li>
            <asp:Label ID="lblModel" runat="server" Text="Label"></asp:Label>当前表:<asp:Label ForeColor="Red" Style="margin-left: 5px;" ID="Label1" runat="server" Text=""></asp:Label>
        </li>
        <%= Call.GetHelp(64) %>
    </ol>
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody id="DivMoneyType2" style="display: none" runat="server">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="NumberType_TitleSizemoney" CssClass="form-control pull-left" Style="max-width: 80px;" runat="server" Columns="10" MaxLength="4">35</asp:TextBox>
                    <span class="tips">px</span>
                </td>
            </tr>
            <tr class="tdbg" id="Tr1" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
                ...
                <td>
                    <asp:TextBox ID="txtdecimalmoney" CssClass="form-control pull-left" Style="max-width: 80px;" runat="server" Text="0"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:TextBox ID="NumberType_DefaultValuemoney" CssClass="form-control pull-left" Style="max-width: 200px;" runat="server" Columns="10"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
