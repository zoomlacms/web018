<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.CollectionStep2, App_Web_mygm4ddm" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                <tbody id="Tabs0">
                                    ...
                                    <tr>
                                        <td></td>
                                        <td>
                                            <asp:Button ID="Button5" runat="server" class="btn btn-primary" Style="width: 110px;" Text="测试列表" OnClick="Button5_Click" OnClientClick="return checkList('txtListStart','txtListEnd')" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="2">（如果不填写链接开始代码和链接结束代码，将会获取列表页中所有的链接地址！）</td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <td>
                                            <asp:Button ID="Button6" class="btn btn-primary" Style="width: 110px;" runat="server" Text="测试链接" OnClick="Button6_Click" OnClientClick="return checkList('txtLinkStart','txtLinkEnd')" />
                                        </td>
                                    </tr>
                                </tbody>
