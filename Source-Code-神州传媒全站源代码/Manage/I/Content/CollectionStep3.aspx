<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.CollectionStep3, App_Web_mygm4ddm" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <asp:DataList ID="DataList2" CssClass="table table-striped table-bordered table-hover" runat="server" Width="100%">
        <ItemTemplate>
            <%#GetHtml(DataBinder.Eval(Container.DataItem, "FieldAlias").ToString(), DataBinder.Eval(Container.DataItem, "FieldName").ToString(),  DataBinder.Eval(Container.DataItem, "FieldType").ToString(), DataBinder.Eval(Container.DataItem, "Content").ToString(), DataBinder.Eval(Container.DataItem, "Description").ToString(), DataBinder.Eval(Container.DataItem, "ModelID").ToString())%>
        </ItemTemplate>
    </asp:DataList>
