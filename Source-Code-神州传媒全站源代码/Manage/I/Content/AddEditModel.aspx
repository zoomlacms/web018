<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_AddEditModel, App_Web_mygm4ddm" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
	...
	<tr class="tdbg">
		...
		<td>
			...
			<asp:TextBox ID="TxtTableName" CssClass="form-control" runat="server" Width="108" MaxLength="50" AutoPostBack="True" /><span class="spanl_30"><font color="red">*</font>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="RequiredFieldValidator" ControlToValidate="TxtTableName">数据表名不能为空</asp:RequiredFieldValidator></span>
		</td>
	</tr>
   ...
   <tr class="tdbg">
	...
	<tr class="tdbg">
		...
		<td>
			<asp:TextBox ID="TxtItemIcon" CssClass="form-control pull-left" Text="Default.gif" runat="server" Width="156" MaxLength="20" />
			<span class="spanl_30 pull-left" style="margin-right:5px;"><asp:Image ID="ImgItemIcon" runat="server" ImageUrl="/Images/ModelIcon/Default.gif" /><=</span><asp:DropDownList ID="DrpItemIcon" CssClass="form-control pull-left" Width="160" runat="server" />
		</td>
	</tr>
	<tr class="tdbg">
		<td class="tdbgleft">
...
<style>
    .spanl_30{ line-height:36px; margin-left:5px;}
</style>
</asp:Content>
