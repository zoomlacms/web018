<%@ page language="C#" autoeventwireup="true" inherits="manage_Workload_Subject, App_Web_0jt1ew4k" masterpagefile="~/Manage/I/Default.master" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div id="Excel" runat="server" visible="false" style="text-align: center; margin-top: 10px;">
        ...
        <input type="button" id="GetExcel" name="GetExcel" value="生成Excel文件" class="btn btn-primary" onclick="GetExcelWithPath('tb','<%=CustomerPageAction.customPath2+"I/Content/GetExcel.aspx"%>    ')" />
    </div>
