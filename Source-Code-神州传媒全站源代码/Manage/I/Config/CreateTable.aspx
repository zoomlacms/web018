<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_Default2, App_Web_c4kn5u0v" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table  class="table table-striped table-bordered table-hover">
        ...
        <tr>
            <td></td>
            <td>
                <asp:Button ID="CreateBtn" runat="server" Text="创建" OnClick="CreateBtn_Click" class="btn btn-primary" /></td>
        </tr>
    </table>
