<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Config_ThumbConfig, App_Web_c4kn5u0v" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div runat="server" id="tu">
      ...
      <tr >
        ...
        <td >
            <asp:TextBox ID="iAlp" runat="server" Width="50" class="from-control pull-left"></asp:TextBox>
