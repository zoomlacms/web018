<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_BackupRestore, App_Web_c4kn5u0v" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
System.Convert.ToInt32(Eval("type")) == 1 ? "DelDir":"DelFiles" %>'
    ...
    <table class="table table-striped table-bordered table-hover">
        <tr class="tdbg">
            ...
            <td>
                <asp:TextBox ID="DatabasePath" class="form-control" runat="server"></asp:TextBox>&nbsp;* 默认为网站根目录下的temp目录
            </td>
        </tr>
        <tr class="tdbg">
    ...
    <table class="table table-striped table-bordered table-hover">
        <tr class="tdbg">
            ...
            <td>
                <asp:TextBox ID="SiteText" class="form-control" runat="server" />&nbsp;* 默认为网站根目录下的temp目录
            </td>
        </tr>
        <tr class="tdbg">
    ...
    <div style="color: #f00; line-height: 25px; padding-left: 20px;">
        <asp:Label ID="runResult" runat="server" Visible="false" Text="还原数据库需如下操作：<br />1.断开数据库连接，因数据库有可能正在运行；<br />2.选择还原数据源；<br />3.删除数据库绑定的专属用户；<br />4.重新绑定用户。<br />* *如有问题可联系管理员进行还原。**"></asp:Label></div>
</asp:Content>
