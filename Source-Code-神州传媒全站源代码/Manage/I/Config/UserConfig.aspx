<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="ZoomLa.WebSite.Manage.Config.UserConfig, App_Web_c4kn5u0v" validaterequest="false" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover">
        <tbody id="Tabs0">
            <tr>
                <td style="width: 300px"><strong>是否开启会员注册：</strong></td>
            ...
            <tr>
                <td style="width: 300px"><strong>会员注册协议：</strong></td>
                <td>
            ...
            <tr>
                <td style="width: 300px"><strong>允许用户名注册规则：</strong></td>
                <td style="width: 500px">
            ...
            <tr>
                <td style="width: 300px"><strong>是否开启用户ID登录：</strong></td>
                <td style="width: 500px">
            ...
            <tr>
                <td style="width: 300px"><strong>开启注册手机验证码校验：</strong></td>
                <td style="width: 500px">
            ...
            <tr>
                <td style="width: 300px"><strong>会员注册默认状态：</strong></td>
                <td style="width: 500px">
            ...
            <tr>
                <td style="width: 300px"><strong>是否开启注册Email验证：</strong></td>
                <td style="width: 500px">
            ...
            <tr>
                <td style="width: 300px"><strong>是否开启Email注册登录：</strong></td>
                <td style="width: 500px">
            ...
            <tr>
                <td style="width: 300px"><strong>是否开启注册成功邮件提醒：</strong></td>
                <td style="width: 500px">
            ...
            <tr>
                <td style="width: 300px"><strong>是否开启用户注册管理员验证：</strong></td>
                <td style="width: 500px">
            ...
            <tr>
                <td style="width: 300px"><strong>是否允许一个Email注册多个会员：</strong></td>
                <td style="width: 500px">
            ...
            <tr>
                <td style="width: 300px"><strong>会员注册时是否启用验证码功能：<br />
            ...
            <tr>
                <td style="width: 300px"><strong>会员登陆是否启用验证码功能：<br />
            ...
            <tr>
                <td style="width: 300px"><strong>是否允许多人同时使用同一会员帐号登陆：</strong></td>
                <td style="width: 500px">
            ...
            <tr>
                <td style="width: 300px"><strong>新会员注册时用户名最少字符数：</strong></td>
                <td style="width: 500px">
            ...
            <tr>
                <td style="width: 300px"><strong>新会员注册时用户名最多字符数：</strong></td>
                <td style="width: 500px">
            ...
            <tr>
                <td style="width: 300px"><strong>禁止注册的用户名：<br />
            ...
            <tr>
                <td><strong>会员注册时的必填、选填项目：</strong><br />
            ...
            <tr>
                <td style="width: 300px"><strong>新会员注册时发送的验证邮件内容：<br />
                </strong>邮件内容支持HTML，邮件内容中可用标签说明如下：<br />
                    <span>{$CheckNum}</span>：验证码<br />
                    <span>{$CheckUrl}</span>：验证地址 </td>
                <td style="width: 500px">
                    <asp:TextBox ID="TextBox12" runat="server" Rows="6" TextMode="MultiLine" Width="300px"
                        class="form-control"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 300px"><strong>注册成功时发送的提醒邮件内容：<br />
                </strong>邮件内容支持HTML，邮件内容中可用标签说明如下：<br />
                    <span>{$UserName}</span>：用户名<br />
                    <span>{$UserPwd}</span>：密码 </td>
                <td style="width: 500px">
                    <asp:TextBox ID="txtEmailTell" runat="server" Rows="6" TextMode="MultiLine" Width="300px"
                        class="form-control"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 300px"><strong>使用邮箱注册自动验证邮件内容：<br />
                </strong>邮件内容支持HTML，邮件内容中可用标签说明如下：<br />
                ...
                <td style="width: 500px">
                    <asp:TextBox ID="txtEmailRegInfo" runat="server" Rows="6" TextMode="MultiLine" Width="300px"
                        class="form-control"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 300px"><strong>使用邮箱找回密码邮件内容：<br />
                </strong>邮件内容支持HTML，邮件内容中可用标签说明如下：<br />
                ...
                <td style="width: 500px">
                    <asp:TextBox ID="txtGetPassword" runat="server" Rows="6" TextMode="MultiLine" Width="300px"
                        class="form-control"></asp:TextBox></td>
            </tr>
            <tr>
                <td style="width: 300px"><strong>新会员注册时发送的手机验证短信内容：<br />
                </strong>短信内容中可用标签说明如下（内容不超过70个字）：<br />
                    <span>{$CheckNum}</span>：会员名称<br />
                    <span>{$SiteName}</span>：网站名称<br />
                    <span>{$SiteUrl}</span>：网站地址</td>
                <td style="width: 500px">
                    <asp:TextBox ID="txtMobileRegInfo" runat="server" Rows="6" TextMode="MultiLine" Width="300px"
                        class="form-control"></asp:TextBox></td>
            </tr>
        </tbody>
        <tbody id="Tabs1" style="display: none">
            <tr
                ...
                <td><strong>会员每登录一次奖励的积分：</strong><br />
                    一天只计算一次 </td>
                <td>
                    <asp:TextBox ID="TxtPresentExpPerLogin" Text="0" runat="server" Columns="5" class="form-control" />
                    分积分 </td>
            </tr>
            <tr
                runat="server" id="Tr1">
          ...
          <asp:RegularExpressionValidator ID="ValgTxtPresentMoney" runat="server" ControlToValidate="TxtPresentMoney"
            ...
            <tr>
                <td><strong>应付佣金占赠送积分的百分比：</strong></td>
                <td>
        ...
        <tbody id="Tabs2" style="display: none">
            <tr>
                <td style="width: 300px"><strong>会员找回密码的方式：</strong></td>
                <td style="width: 500px">
        ...
        <tbody id="Tabs3" style="display: none">
          ...
          <asp:RegularExpressionValidator ID="ValgPresentPoint" runat="server" ControlToValidate="TxtPresentPoint"
            ...
            <tr>
                <td style="width: 300px">资料填写完整赠送点券 </td>
                <td style="width: 500px">
        ...
        <tbody id="Tabs4" style="display: none">
            <tr>
                <td align="right" style="height: 23px" valign="middle"><strong>是否对同一IP注册进行时间间隔限制：</strong></td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtLimitTime" class="form-control" runat="server" onkeyup="if(this.value.length==1){this.value=this.value.replace(/[^1-9]/g,'')}else{this.value=this.value.replace(/\D/g,'')}"
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="Button1" runat="server" Text="保存设置" OnClick="Button1_Click" class="btn btn-primary" /></td>
        </tr>
    </table>
