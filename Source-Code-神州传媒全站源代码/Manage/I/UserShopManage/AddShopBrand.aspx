<%@ page language="C#" autoeventwireup="true" inherits="manage_UserShopManage_AddShopBrand, App_Web_dhharc22" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td height="22" valign="middle">
                ...
                <iframe id="proimgs" style="top: 2px" src="fileupload.aspx?menu=TrPhoto" width="100%" height="25px" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
            </td>
        </tr>
        <tr>
