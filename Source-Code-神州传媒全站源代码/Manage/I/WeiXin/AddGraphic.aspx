<%@ page language="C#" autoeventwireup="true" inherits="manage_WeiXin_AddWx, App_Web_uaxiewkc" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border">
                    <tr class="tdbg">
                        ...
                        <td>
                            ...
                            <input type="button" id="Button2" onclick="javascript: window.history.go(-1)" class="C_input" value="取消" /></td>
                    </tr>
                </table>
            </td>
