<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_RecycleNodeTree, App_Web_yp2te3bo" clientidmode="Static" %>
   
<div class="menu_tit"><span class="glyphicon glyphicon-globe"></span>内容管理</div>
 <div id="nodeNav" style="padding:0 0 0 0;">
        <div class="input-group">
            <input type="text" ID="keyWord" class="form-control" onkeydown="return ASCX.OnEnterSearch('<%:CustomerPageAction.customPath2+"I/Content/ContentRecycle.aspx?keyWord=" %>',this);" placeholder="搜索内容" />
