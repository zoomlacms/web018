<%@ control language="C#" autoeventwireup="true" inherits="Manage_I_ASCX_LabelGuide, App_Web_yp2te3bo" %>
<link type="text/css" href="/App_Themes/ICMS/Guide.css" rel="stylesheet" />
<div class="menu_tit">标签管理</div>
<div class="tvNavDiv" style="height:auto;">
    <div class="left_ul">
        <ul>
            ...
            <li><a href="javascript:;" onclick="ShowMain('','{$path}I/Template/DSManage.aspx')">外部数据库源</a></li>
            <li><a href="javascript:;" onclick="ShowMain('','{$path}I/Template/LabelCallTab.aspx')">标签助手</a></li>
            <li><a href="javascript:;" onclick="ShowMain('','/api/GetPageHtml.aspx')">源码查看器</a></li>
        </ul>
        <div class="clearfix"></div>
    </div>
     <div class="input-group margintop10" >
        <input type="text" id="keyWord" class="form-control" placeholder="请输入标签名称"  onkeydown="return ASCX.OnEnterSearch('<%:CustomerPageAction.customPath2+"I/Template/LabelManage.aspx?keyWord=" %>',this);"/>
