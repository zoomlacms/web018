<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Default, App_Web_0v2ieslu" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<%@ Register Src="~/Manage/I/ASCX/IE6.ascx" TagName="IE6" TagPrefix="ZLC" %>
<!DOCTYPE html>
...
<link type="text/css" rel="stylesheet" href="/App_Themes/ICMS/V3.css?id=v2" />
<script type="text/javascript" src="/JS/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="/JS/jquery-ui.min.js"></script>
<script type="text/javascript" src="/MIS/JS/FrameTab.js"></script>
<script type="text/javascript" src="/js/alt.js"></script>
</head>
<body style="overflow-y:hidden;">
<form id="form1" runat="server">
<ZLC:IE6 runat="server" />
<!--[if lt IE 7]>
<script>
if (confirm("响应式后台不支持IE6,是否切换为传统模式？")) {
	location.href = '<%= CustomerPageAction.customPath2 %>Default.aspx';
}
</script>
<![endif]-->
<asp:ScriptManager ID="SM1" runat="server"></asp:ScriptManager>
<div class="m_top">
<div class="padding0 col-lg-2 col-md-2 col-sm-2 col-xs-5 main_left">
<a href="/">
	<img src="<%= Call.Logo %>" alt="逐浪CMS_后台管理系统" class="logoAdmin" />
</a>
</div>
<div class="col-lg-10 col-md-10 col-sm-10 col-xs-7 pull-right margin-15 padding0 m_top_right main_right" style="padding-left:15px;">
<div class="col-lg-9 col-md-10 col-sm-9 col-xs-12 hidden-xs">
	<div style="height: 42px;" class="m_top_menu row">
		<ul class="list-unstyled ">
			<li class="menu1 active" onclick="openmenu('menu1')"><a onclick="showleft('menu1_1');" data-toggle="tooltip" data-placement="top" title="我的工作台"><span><%:lang.LF("我的工作台") %></span></a></li>
...
<div class="col-lg-3 col-md-2 col-sm-3 col-xs-12 padding0 m_top_rl">
	<div id="Announce">
		<div class="dropdown pull-right">
			<a data-toggle="dropdown" href="javascript:;" style="color:white;">
				<label runat="server" id="nameL"></label>
				<span class="caret"></span>
			</a>
			<ul class="dropdown-menu" role="menu" aria-labelledby="dLabel">
				<li><a href="/" target="_blank" title="网站首页"><%:lang.LF("网站首页") %></a></li>
				<li><a href="<%=CustomerPageAction.customPath2 %>Default.aspx"><%:lang.LF("经典后台") %></a></li>
				<li><a href="<%= CustomerPageAction.customPath2 %>Site/SiteConfig.aspx" title="站群模式"><%:lang.LF("站群模式") %></a></li>
				<li><a href="javascript:;" title="中英文切换"><%:lang.LF("切换语言") %></a></li>
				<li><a href="javascript:ShowMain('','<%= CustomerPageAction.customPath2+"I/Scence.aspx" %>');" title="场景切换"><%:lang.LF("场景切换") %></a></li>
				<li><a href="javascript:modalDialog('/Common/calc.html', 'calculator', 400, 300);"><%:lang.LF("计算器") %></a></li>
				<li><a href="http://help.zoomla.cn/" target="_blank"><%:lang.LF("在线帮助") %></a></li>
				<li><a href="<%= CustomerPageAction.customPath2 %>SignOut.aspx" title="安全退出"><%:lang.LF("安全退出") %></a></li>
				<li><a href="/User/" title="ALT+U进入会员中心" target="_blank"><%:lang.LF("会员中心") %></a></li>
				<li><a href="javascript:;" style="cursor: pointer;" title='Alt+Q锁定屏幕' onclick="showWindow('Lockin.aspx',900,460);"><%:lang.LF("锁定屏幕") %></a></li>
			</ul>
		</div>
	</div>
...
<ul class="menu2">
	...
	<li class="menu2_4"><a onclick="showleft('menu2_4','Pub/PubManage.aspx')"><%:lang.LF("互动模块") %></a></li>
	<li class="menu2_5"><a onclick="showleft('menu2_5','Content/CollectionManage.aspx')"><%:lang.LF("信息采集") %></a></li>
	...
	<li class="menu2_9"><a onclick="showleft('menu2_9','Guest/GuestCateMana.aspx')"><%:lang.LF("百科问答") %></a></li>
...
<ul class="menu3">
	...
	<li class="menu3_13"><a onclick="showleft('menu3_13','Content/ModelManage.aspx?ModelType=6')"><%:lang.LF("店铺管理") %></a></li>
...
<ul class="menu4">
    ...
    <li class="menu4_3"><a onclick="showleft('menu4_3','Page/PageTemplate.aspx')"><%:lang.LF("栏目设定") %></a></li>
...
<ul class="menu6">
	...
	<li class="menu6_5"><a onclick="showleft('menu6_5','User/SubscriptListManage.aspx?menu=audit')"><%:lang.LF("订阅中心") %></a></li>
...
<ul class="menu8">
	...
	<li class="menu8_6"><a onclick="showleft('menu8_6','Template/TemplateSet.aspx')"><%:lang.LF("模板风格") %></a></li>
	<li class="menu8_7"><a onclick="ShowMain('LabelGuide.ascx','Template/LabelManage.aspx','Template/LabelManage.aspx')"><%:lang.LF("标签管理") %></a></li>
...
<div class="modal-content">
	<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9 padding0 back_black" style="height: 100%; overflow-y: auto;">
		...
		<ul class="list-unstyled modal_ul">
			<li><a href="/"><span class="glyphicon glyphicon-home"></span><%:lang.LF("网站首页") %></a></li>
			<li>
			...
			<li>
				...
				<ul style="position: relative; display: none;">
					...
					<li><a data-dismiss="modal" onclick="showleft('menu2_5','Content/CollectionManage.aspx');" href="javascript:;"><%:lang.LF("信息采集") %></a> </li>
					...
					<li><a data-dismiss="modal" onclick="showleft('menu2_9','Guest/GuestCateMana.aspx');" href="javascript:;"><%:lang.LF("百科问答") %></a></li>
...
<%--                                    <li><a href="javascript:;"><%:lang.LF("微博管理") %></a> </li>--%>
			...
			<li>
				...
				<ul style="position: relative; display: none;">
					...
					<li><a data-dismiss="modal" onclick="showleft('menu8_6','Template/LabelManage.aspx')" href="javascript:;"><%:lang.LF("模板风格") %></a></li>
					<li><a data-dismiss="modal" onclick="ShowMain('LabelGuide.ascx','Template/LabelManage.aspx','Template/LabelManage.aspx')" href="javascript:;"><%:lang.LF("标签管理") %></a></li>
	...
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 padding0 back_white">
		...
		<div class="modal_close text-center" data-dismiss="modal" style="bottom: 90px; width: 100px; border-radius: 5px;"
			onclick="location='<%:CustomerPageAction.customPath2+"Site/SiteConfig.aspx" %>';">
			<%:lang.LF("站群模式") %>
		</div>
...
<div id="left_ul_div">
	<div id="menu1" class="unstyled m_left_ul open">
		...
		<ul id="menu1_2" class="m_left_ulin">
			...
			<li id="menu1_2_1"><a href="javascript:;" data-url="Config/AddSearch.aspx"><%:lang.LF("添加便捷导航") %></a></li>
			<li id="menu1_2_2"><a href="javascript:;" data-url="Config/SearchFunc.aspx"><%:lang.LF("便捷导航") %></a></li>
		</ul>
	...
	<div id="menu2" class="m_left_ul">
		...
		<ul class="list-unstyled m_left_ulin" id="menu2_4">
			...
			<li id="menu2_4_5"><a href="javascript:;" data-url="Pub/PubRecycler.aspx"><%:lang.LF("存档管理") %></a></li>
		</ul>
		<ul class="list-unstyled m_left_ulin" id="menu2_5">
			<li class="menu_tit"><span class="glyphicon glyphicon-globe"></span>信息采集</li>
			<li id="menu2_5_1"><a href="javascript:;" data-url="Content/CollectionManage.aspx"><%:lang.LF("采集项目管理") %></a></li>
			<li id="menu2_5_2"><a href="javascript:;" data-url="Content/CollectionStep1.aspx"><%:lang.LF("添加采集项目") %></a></li>
			...
			<li id="menu2_5_5"><a href="javascript:;" data-url="Content/CollectionList.aspx"><%:lang.LF("采集历史记录") %></a></li>
		</ul>
		...
		<ul class="list-unstyled m_left_ulin" id="menu2_9">
			...
			<li id="menu2_9_1"><a href="javascript:;" data-url="Guest/GuestCateMana.aspx"><%:lang.LF("留言分类管理") %></a></li>
			<li id="menu2_9_2"><a href="javascript:;" data-url="Guest/BkCheck.aspx"><%:lang.LF("百科词条管理") %></a></li>
			<li id="menu2_9_3"><a href="javascript:;" data-url="AddOn/GradeOption.aspx?CateID=3"><%:lang.LF("百科分类管理") %></a></li>
		...
		<ul class="list-unstyled m_left_ulin" id="menu2_10">
			...
			<li id="menu2_10_3"><a href="javascript:;" data-url="AddOn/KeyWordManage.aspx"><%:lang.LF("关键字管理") %></a></li>
	...
	<div id="menu3" class="m_left_ul">
		...
		<ul id="menu3_2" class="m_left_ulin">
			...
			<li id="menu3_2_2"><a href="javascript:;" data-url="Shop/Stock.aspx"><%:lang.LF("添加入库出库记录") %></a></li>
		</ul>
		...
		<ul id="menu3_4" class="m_left_ulin">
			...
			<li id="menu3_4_4"><a href="javascript:;" data-url="Shop/InvoiceList.aspx"><%:lang.LF("开发票明细") %></a></li>
			<li id="menu3_4_5"><a href="javascript:;" data-url="Shop/DeliverList.aspx"><%:lang.LF("开退货明细") %></a></li>
		</ul>
		...
		<ul id="menu3_7" class="m_left_ulin">
			...
			<li id="menu3_7_1"><a href="javascript:;" data-url="Shop/DeliverType.aspx"><%:lang.LF("送货方式设置") %></a></li>
			...
			<li id="menu3_7_4"><a href="javascript:;" data-url="Shop/Producer.aspx"><%:lang.LF("添加厂商") %></a></li>
			<li id="menu3_7_5"><a href="javascript:;" data-url="Shop/TrademarkManage.aspx"><%:lang.LF("品牌管理") %></a></li>
			<li id="menu3_7_6"><a href="javascript:;" data-url="Shop/Trademark.aspx"><%:lang.LF("添加品牌") %></a></li>
			<li id="menu3_7_7"><a href="javascript:;" data-url="Shop/CardManage.aspx"><%:lang.LF("VIP卡管理") %></a></li>
			<li id="menu3_7_8"><a href="javascript:;" data-url="Shop/CashManage.aspx"><%:lang.LF("处理VIP卡提现金") %></a></li>
			<li id="menu3_7_9"><a href="javascript:;" data-url="Shop/ProductCashManage.aspx"><%:lang.LF("厂商提取现金") %></a></li>
			<li id="menu3_7_10"><a href="javascript:;" data-url="Shop/BossSite.aspx"><%:lang.LF("提成比例设置") %></a></li>
			<li id="menu3_7_11"><a href="javascript:;" data-url="Shop/MoneyManage.aspx"><%:lang.LF("货币管理") %></a></li>
			<li id="menu3_7_13"><a href="javascript:;" data-url="Shop/InvtoManage.aspx"><%:lang.LF("发票计算") %></a></li>
		</ul>
		...
		<ul id="menu3_13" class="m_left_ulin">
			...
			<li id="menu3_13_1"><a href="javascript:;" data-url="UserShopManage/StoreManage.aspx"><%:lang.LF("店铺申请与审核") %></a></li>
	...
	<div id="menu6" class="m_left_ul">
		...
		<ul class="m_left_ulin" id="menu6_2">
			...
			<li id="menu6_2_2"><a href="javascript:;" data-url="User/RoleManage.aspx"><%:lang.LF("角色管理") %></a></li>
		</ul>
	...
	<div id="menu7" class="m_left_ul">
		<ul class="m_left_ulin open" id="menu7_1">
			...
			<li id="menu7_1_1"><a href="javascript:;" data-url="Config/DatalistProfile.aspx"><%:lang.LF("系统全库概况") %></a></li>
			<li id="menu7_1_2"><a href="javascript:;" data-url="Config/BackupRestore.aspx"><%:lang.LF("备份还原数据") %></a></li>
			<li id="menu7_1_3"><a href="javascript:;" data-url="Config/Optimization.aspx"><%:lang.LF("数据索引优化") %></a></li>
			<li id="menu7_1_4"><a href="javascript:;" data-url="Common/SystemFinger.aspx"><%:lang.LF("服务器信息总览") %></a></li>
			<li id="menu7_1_5"><a href="javascript:;" data-url="Content/Print_Type.aspx"><%:lang.LF("全库数据检索") %></a></li>
			<li id="menu7_1_7"><a href="javascript:;" data-url="Config/DataSearch.aspx"><%:lang.LF("快速建表") %></a></li>
			<li id="menu7_1_8"><a href="javascript:;" data-url="Config/RunSql.aspx"><%:lang.LF("执行SQL语句") %></a></li>
			<li id="menu7_1_9"><a href="javascript:;" data-url="Config/DataAssert.aspx"><%:lang.LF("表内容批处理") %></a></li>
			<li id="menu7_1_10"><a href="javascript:;" data-url="Config/EmptyData.aspx"><%:lang.LF("清空测试数据") %></a></li>
			<li id="menu7_1_11"><a href="javascript:;" data-url="Config/ViewList.aspx"><%:lang.LF("视图管理") %></a></li>
		</ul>
		<ul class="m_left_ulin" id="menu7_2">
			...
			<li id="menu7_2_5"><a href="javascript:;" data-url="Panoramic/PanoramicManage.aspx"><%:lang.LF("全景管理") %></a></li>
			<li id="menu7_2_6"><a href="javascript:;" data-url="Panoramic/MusicManage.aspx"><%:lang.LF("音乐库管理") %></a></li>
		...
		<ul class="m_left_ulin" id="menu7_7">
			...
			<li id="menu7_7_2"><a href="javascript:;" data-url="File/tjlink.aspx"><%:lang.LF("添加站内链接") %></a></li>
		</ul>
	...
	<div id="menu8" class="m_left_ul">
		...
		<ul class="m_left_ulin" id="menu8_3">
			...
			<li id="menu8_3_2"><a href="javascript:;" data-url="Content/BatchNode.aspx"><%:lang.LF("节点批量设置") %></a></li>
			<li id="menu8_3_3"><a href="javascript:;" data-url="Content/UnionNode.aspx"><%:lang.LF("节点合并迁移") %></a></li>
		</ul>
		<ul class="m_left_ulin" id="menu8_4">
			...
			<li id="menu8_4_2"><a href="javascript:;" data-url="Content/AuditingState.aspx"><%:lang.LF("状态码管理") %></a></li>
		</ul>
		...
		<ul class="m_left_ulin" id="menu8_6">
			...
			<li id="menu8_6_1"><a href="javascript:;" data-url="Template/TemplateSet.aspx"><%:lang.LF("方案设置") %></a></li>
			<li id="menu8_6_2"><a href="javascript:;" data-url="Template/TemplateManage.aspx"><%:lang.LF("模板管理") %></a></li>
		...
		<ul class="m_left_ulin" id="menu8_8">
			...
			<li id="menu8_8_5"><a href="javascript:;" data-url="Pay/Paypalmanage.aspx"><%:lang.LF("支付平台") %></a></li>
		</ul>
	</div>
	<div id="menu9" class="m_left_ul">
		<ul class="m_left_ulin open" id="menu9_1">
			...
			<li id="menu9_1_4"><a href="javascript:;" data-url="WorkFlow/MisModelManage.aspx"><%:lang.LF("表格管理") %></a></li>
...
<asp:UpdatePanel ID="LeftPanel" runat="server" EnableViewState="false">
	<ContentTemplate>
		<div runat="server" id="left_Div" style="overflow-y:auto;position:relative;height:820px;"></div>
...
<div id="leftSwitch" style="cursor:pointer;position:absolute;margin-top:12%;z-index:10;display:none;" onclick="hideleft();">
...
<script type="text/javascript" src="/JS/ICMS/ascx.js"></script>
<script type="text/javascript" src="/JS/ICMS/alt.js"></script>
<script type="text/javascript" src="/JS/ICMS/Main.js?version=201408137z4h"></script>
...
//----边栏滚动条高度
$("#left_Div").height($(window).height() - 150);
}
setLayout();
