<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_Arrive_ArriveManage, App_Web_eo2auy1z" enableviewstate="true" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div>
        <table class="table table-striped table-bordered table-hover">
            <tr>
                <td>
                    <div>优惠劵名：<asp:TextBox ID="txtName" runat="server" class="form-control"></asp:TextBox></div>
                    <div style="margin: 5px 0 5px 0;">有效时间：<asp:TextBox ID="txtCreateTime" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd'});" runat="server" class="form-control"></asp:TextBox></div>
                    <div>过期时间：<asp:TextBox ID="txtEndTime" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd'});" runat="server" class="form-control" Style="margin-bottom: 10px;"></asp:TextBox></div>
