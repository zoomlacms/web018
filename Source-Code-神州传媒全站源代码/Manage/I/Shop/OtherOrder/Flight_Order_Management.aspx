<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_Flight_Order_Management, App_Web_u0a4prgv" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <asp:Repeater ID="Orderlisttable" runat="server">
            <ItemTemplate>
                <tr class="tdbg" id="<%#Eval("id") %>" ondblclick="getinfo(this.id)">
                    ...
                    <td>
                        <a onclick="opentitle('../../User/Userinfo.aspx?id=<%#Eval("userId") %>','查看会员')" href="javascript:;" title="查看会员"><%#GetUsers(DataBinder.Eval(Container, "DataItem.userId", "{0}"))%></a>
                    </td>
                    <td>
                        <%#Eval("AddTime") %>
                    </td>
