<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_OtherOrder_Travel_Orderinfo, App_Web_ypms3lsl" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <!--endprint-->
     <table width="100%" cellpadding="2" cellspacing="1" class="table table-striped table-bordered table-hover" 
        ...
        <tbody id="Tbody4">
            <tr class="tdbg">
                <td width="25%" rowspan="3" style="text-align:center">
                <asp:Label ID="Label31" runat="server" Text="" Visible="false" ></asp:Label>
                    <asp:Button ID="Button4" class="btn btn-primary"   style="width:100px;" runat="server" Text="确认订单"  OnClick="Button4_Click"  /><br />
                    <asp:Button ID="Button5" class="btn btn-primary"   style="width:100px;" runat="server" Text="取消确认"  OnClick="Button5_Click"  /><br />
                    <asp:Button ID="Button3" class="btn btn-primary"   style="width:100px;" runat="server" Text="发货"  OnClick="Button3_Click"  />
                </td>
                <td width="25%" rowspan="3" style="text-align:center">
                    <asp:Button ID="Button2" class="btn btn-primary"   style="width:100px;" runat="server" Text="已经支付"  OnClick="Button2_Click"  /><br />
                    <asp:Button ID="Button7" class="btn btn-primary"   style="width:100px;" runat="server" Text="客户已签收"  OnClick="Button7_Click"  /><br />
                    <asp:Button ID="Button6" class="btn btn-primary"   style="width:100px;" runat="server" Text="订单作废"  OnClick="Button6_Click" />
                </td>
                <td width="25%" rowspan="3" style="text-align:center">
                    <asp:Button ID="Button13" class="btn btn-primary"   style="width:100px;" runat="server" Text="暂停处理"  OnClick="Button13_Click"  /><br />
                    <asp:Button ID="Button14" class="btn btn-primary"   style="width:100px;" runat="server" Text="恢复正常"  OnClick="Button14_Click"  /><br />
                    <asp:Button ID="Button12" class="btn btn-primary"   style="width:100px;" runat="server" Text="删除订单"  OnClick="Button12_Click"  />
                </td>
                <td width="25%" rowspan="3" style="text-align:center">
                    <asp:Button ID="Button9" class="btn btn-primary"   style="width:100px;" runat="server" Text="结清订单"  OnClick="Button9_Click"  /><br />
                    <asp:Button ID="Button11" class="btn btn-primary"   style="width:100px;" runat="server" Text="开发票"  OnClick="Button11_Click" /><br />
                 </td>
            </tr>
            <tr class="tdbg">
            </tr>
