<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_Hotel_Order_Manager, App_Web_u0a4prgv" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover">
        <tbody id="Tbody1">
            ...
            <tr>
                <td height="24" colspan="11">说明：“已结清”与“已付款”的订单不允许删除,当订单号码成“灰色”代表此订单已“作废”
                </td>
            </tr>
            <tr>
                <td height="24" colspan="11">
                    <asp:Button ID="Button1" Style="width: 110px" class="btn btn-primary" Text="删除订单" runat="server"
