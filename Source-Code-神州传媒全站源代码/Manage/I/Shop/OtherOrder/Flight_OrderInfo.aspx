<%@ page language="C#" autoeventwireup="true" inherits="manage_Shop_OtherOrder_Flight_OrderInfo, App_Web_ypms3lsl" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
class="table table-striped table-bordered table-hover">
    ...
    <br />
    <div>
        <font style="font-size:large">乘客信息：</font>&nbsp;&nbsp;&nbsp;保险总数:<asp:Label ID="lblIns" runat="server"></asp:Label>
    </div>
    <table width="100%"
class="table table-striped table-bordered table-hover" >
        <tbody id="Tbody2">
