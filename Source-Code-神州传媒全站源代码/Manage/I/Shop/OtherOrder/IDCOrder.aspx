<%@ page language="C#" autoeventwireup="true" inherits="Manage_Shop_OtherOrder_DomainOrder, App_Web_u0a4prgv" validaterequest="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
            ...
            <td>
                ...
                <div class="input-group pull-left" style="width:300px;">
                    ...
                    <span class="input-group-btn">
                        <asp:LinkButton runat="server" CssClass="btn btn-default" ID="souchok" OnClick="souchok_Click"><span class="glyphicon glyphicon-search"></span></asp:LinkButton></span>
                </div>
    ...
    <div id="TableList" runat="server">
        <table id="EGV" class="table table-striped table-bordered table-hover">
            ...
            <asp:Repeater ID="Orderlisttable" runat="server" OnItemCommand="Orderlisttable_ItemCommand">
                <ItemTemplate>
                    <tr class="tdbg" id='<%#Eval("id") %>' ondblclick="getinfo(this.id)">
                        ...
                        <td><%#formatcs(DataBinder.Eval(Container,"DataItem.Receivablesamount","{0:N2}"))%><%#getMoney_sign(Eval("Money_code").ToString())%>
                        </td>
            ...
            <tr class="tdbg">
                <td colspan="11" align="center" class="tdbgleft">
            ...
            <tr>
                <td colspan="11">说明：“已结清”与“已付款”的订单不允许删除,当订单号码成“灰色”代表此订单已“作废”
                </td>
            </tr>
            <tr>
                <td colspan="11">
                    <asp:Button ID="Button1" Style="width: 110px" class="btn btn-primary" Text="批量删除" runat="server" OnClick="Button1_Click1" OnClientClick="if(!IsSelectByName('Item')){alert('请选择内容');return false;}else{return confirm('不可恢复性删除数据,你确定将该数据删除吗？')}" />
                    <asp:Button ID="Button2" Style="width: 110px" class="btn btn-primary" Text="设为成功" runat="server" OnClick="Button2_Click" OnClientClick="if(!IsSelectByName('Item')){alert('请选择内容');return false;}else{return confirm('你确定要将订单设为成功吗？')}" />
                </td>
            </tr>
        </table>
    </div>
    ...
    <table width="100%" id="TimeTb" cellpadding="2" cellspacing="1" class="border" style="background-color: white;" runat="server" visible="false">
        ...
        <tr class="tdbg">
            ...
            <td>
                <asp:Label ID="OrderAddTime" runat="server" Text="Label"></asp:Label></td>
        </tr>
        <tr class="tdbg">
            <td class="tdbgleft"><strong>到期时间：</strong></td>
            <td>
                <asp:TextBox ID="OrderEndTime" runat="server" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox></td>
        </tr>
        <tr class="tdbg">
