<%@ page language="C#" autoeventwireup="true" inherits="Manage_Shop_OtherOrder_DomainOrder, App_Web_ypms3lsl" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover">
        <tbody id="Tbody1">
            ...
            <tr>
                 <td height="24" colspan="11">
                    <asp:Button ID="Button1" Style="width: 110px" class="btn btn-primary" Text="批量删除" runat="server"
                       ...
                       <asp:Button ID="Button2" Style="width: 110px" class="btn btn-primary" Text="设为成功" runat="server"
