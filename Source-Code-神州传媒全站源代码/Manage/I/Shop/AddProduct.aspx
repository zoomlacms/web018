<%@ page language="C#" autoeventwireup="true" validaterequest="false" enableeventvalidation="false" inherits="Zoomla.Website.manage.Shop.AddProduct, App_Web_1qn0akdt" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" viewStateEncryptionMode="Never" %>
                ...
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody id="Tabs3" style="display: none">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div id="userP" runat="server">
                                            会员价：<asp:TextBox ID="userPrice" runat='server' class="form-control" Width="35px"></asp:TextBox>元
                                        </div>
                        ...
                        <tr
                            ...
                            <td>
                                <asp:TextBox ID="txtDayPrice" runat="server" class="form-control" Height="19px"></asp:TextBox>
                        ...
                        <tr
                            ...
                            <td>
                                <asp:TextBox ID="txtBookPrice" runat="server" class="form-control" Height="19px"></asp:TextBox>
                        ...
                        <tr
                            ...
                            <td>
                                <asp:TextBox ID="txtBookDay" runat="server" class="form-control" Height="19px" onclick="WdatePicker({ dateFmt: 'yyyy/MM/dd HH:mm:ss' });"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="height: 26px;">
                            <input id="Button12" class="btn btn-primary" style="width: 100px" type="button" onclick="SelectFlower()"
                                value="添加花材" />
                            <asp:Button ID="Button13" class="btn btn-primary" Style="width: 100px" runat="server" Text="清空花材"
