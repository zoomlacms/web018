<%@ page language="C#" autoeventwireup="true" inherits="manage_iServer_BselectiServer, App_Web_nsjaamio" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <ZL:ExGridView ID="Egv" runat="server" AutoGenerateColumns="False" DataKeyNames="QuestionId" PageSize="10" OnRowDataBound="Egv_RowDataBound" OnPageIndexChanging="Egv_PageIndexChanging" IsHoldState="false" OnRowCommand="Egv_RowCommand" AllowPaging="True" AllowSorting="True" CssClass="table table-striped table-bordered table-hover" EnableTheming="False" EnableModelValidation="True" EmptyDataText="没有内容">
        <Columns>
            ...
            <asp:TemplateField HeaderText="用户名">
                <ItemTemplate>
                    <a onclick="opentitle('<%=customPath2 %>I/User/Userinfo.aspx?id=<%#Eval("UserId") %>','查看会员')" href="javascript:;" title="查看会员"><%#GetUserName(Eval("UserId","{0}"))%></a>
                </ItemTemplate>
            </asp:TemplateField>
