<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="manage_AddOn_AddProjects, App_Web_023fmgmx" enableviewstatemac="false" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <tbody id="Tabs0">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input id="Button3" type="button" value="选择负责人" onclick="Openwin1(); void (0)" class="btn btn-primary" />
                </td>
            </tr>
            <tr>
                <td style="width: 282px;">
