<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="manage_AddOn_Projects, App_Web_mu3cyypc" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ContentPlaceHolderID="Content" runat="Server">
    ...
    <div class="divbox" id="nocontent" runat="server" style="display: none">
        <%=lang.Get("m_Projects_none")%>
    </div>
    <ul class="nav nav-tabs">
        <li class="active"><a id="TabTitle0" onclick="ShowTabss(0,0)"><%=lang.Get("m_Projects_all")%></a></li>
        <li><a id="TabTitle1" onclick="ShowTabss(1,0)"><%=lang.Get("m_Projects_unaudit")%></a></li>
        <li><a id="TabTitle2" onclick="ShowTabss(2,0)"><%=lang.Get("m_Projects_audit")%></a></li>
        <li><a id="TabTitle3" onclick="ShowTabss(3,0)"><%=lang.Get("m_Projects_not")%></a></li>
        <li><a id="TabTitle4" onclick="ShowTabss(4,0)"><%=lang.Get("m_Projects_started")%></a></li>
        <li><a id="TabTitle5" onclick="ShowTabss(5,0)"><%=lang.Get("m_Projects_completed")%></a></li>
        <li><a id="TabTitle6" onclick="ShowTabss(1,0)"><%=lang.Get("m_Projects_save")%></a></li>
    </ul>
