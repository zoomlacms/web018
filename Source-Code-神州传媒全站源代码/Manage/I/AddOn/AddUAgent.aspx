<%@ page language="C#" autoeventwireup="true" inherits="manage_Profile_AddUAgent, App_Web_4fw0kl51" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<div class="r_navigation">
 <%=lang.Get("M_SpecContent_manage")%>  &gt;&gt;<%=lang.Get("M_CommentManage_system")%>  &gt;&gt;<a href="UAgent.aspx"><%=lang.Get("m_UAgent_Manage")%></a> &gt;&gt;<%=lang.Get("m_UAgent_Add")%>
</div>
<table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" style="margin: 0 auto;">
<tbody id="Tabs0">
    <tr class="spacingtitle" style="height:30px;">
		<td align="center" colspan="2" ><asp:Label ID="lblText" runat="server"><%=lang.Get("m_UAgent_Add")%></asp:Label></td>
    </tr>  
