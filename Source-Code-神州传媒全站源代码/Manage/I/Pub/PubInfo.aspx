<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Pub_PubInfo, App_Web_5xejlig2" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline">
            <ContentTemplate>
                ...
                <tr runat="server" id="Pubinfos">
                    ...
                    <td align="left" width="80%">
                        <asp:TextBox ID="Pubinfo" runat="server" Width="476px" CssClass="form-control pull-left" Rows="10" TextMode="MultiLine"></asp:TextBox>
                    </td>
                </tr>
            </ContentTemplate>
        </asp:UpdatePanel>
