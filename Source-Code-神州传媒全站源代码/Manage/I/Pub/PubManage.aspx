<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Pub_PubManage, App_Web_5xejlig2" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <script>
        $().ready(function () {
            HideColumn('1', 'hidden-xs hidden-sm', 'Egv');
        })
    </script>
</asp:Content>
