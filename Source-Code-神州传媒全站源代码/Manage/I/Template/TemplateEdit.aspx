<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="Manage_I_Content_TemplateEdit, App_Web_2a1yk52x" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table width="100%" cellpadding="2" border="0" cellspacing="1" class="table table-striped table-bordered" align="center">
        <tr class="title" style="font-weight: normal;">
            <td align="left" colspan="2">
                &nbsp;<%=ShowPath.Trim()%><asp:TextBox ID="TxtFilename" class="form-control" runat="server"></asp:TextBox>
        ...
        <tr>
            <td align="left" colspan="2">
                <div style="float: left; padding-left: 250px">
                    ...
                    <asp:Button ID="btnReset" Class="btn btn-primary" runat="server" Text="恢复模板" OnClick="btnReset_Click" UseSubmitBehavior="false"/>&nbsp;&nbsp;&nbsp;
                </div>
                <div id="Div1" style="float: left">
                    <asp:Button ID="btn" runat="server" Text="可视化预览" class="btn btn-primary" OnClick="btn_Click" />
