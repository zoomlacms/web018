<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_CssManage, App_Web_rlk1hxfv" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" align="center">
        <tr class="tdbg">
            <td width="10%" align="center">
                <asp:Button ID="Button1" class="btn btn-primary" runat="server" Style="width: 110px;" Text="新建风格" OnClick="Button1_Click" />
            </td>
            <td width="10%" align="center">
