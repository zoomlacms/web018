<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_LabelSql, App_Web_rlk1hxfv" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                    ...
                    <tr>
                        ...
                        <td class="tdbg">
                            ...
                            <table border="0" cellpadding="0" cellspacing="1" class="table table-striped table-bordered" style="text-align: center">
                                <tr class="tdbg" align="center" style="height: 25px;">
                                    <td style="width: 80px;">
                                        <asp:TextBox ID="TxtParamName" CssClass="form-control" runat="server" Text="参数名称" Width="90" />
                                    </td>
                                    <td style="width: 80px; height: 25px">
                                        <asp:TextBox ID="TxtParamValue" runat="server" Text="默认值" CssClass="form-control" Width="90px" /></td>
                                    <td class="tdbg" align="left" style="width: 100px; height: 25px">
                                        <asp:DropDownList ID="DDLParamType" CssClass="form-control" Width="90" runat="server">
                                    ...
                                    <td style="width: 100px; height: 25px" align="left">
                                        <asp:TextBox ID="TxtParamDesc" runat="server" Text="参数说明" CssClass="form-control" Width="90px" /></td>
                                    <td style="width: 80px; height: 25px">
                                        <asp:Button ID="BtnAddParam" runat="server" Text="添加" class="btn btn-primary" OnClick="BtnAddParam_Click" Style="cursor: pointer;" /></td>
