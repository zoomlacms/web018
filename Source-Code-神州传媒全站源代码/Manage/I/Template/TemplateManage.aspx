<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_TemplateManage, App_Web_2a1yk52x" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="1" class="border" align="center">
        <tr class="tdbg">
            <td width="10%" align="center">
                <asp:Button ID="Button1" class="btn btn-primary" runat="server" Text="新建模板" OnClick="Button1_Click" />
            </td>
