<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_DSManage, App_Web_rlk1hxfv" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div>
        <div id="addDSDiv" runat="server" visible="false">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    <td style="text-align: right;">数据库源连接字符串： </td>
                    <td style="height: 22px; text-align: left;">
