<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.ModifyPassword, App_Web_rduinpl3" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtOldPassword" class="form-control" runat="server" TextMode="Password" onkeydown="return GetEnterCode('focus','TxtPassword');"/>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtPassword" class="form-control" runat="server" TextMode="Password" onkeydown="return GetEnterCode('focus','TxtPassword2');" />
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TxtPassword2" class="form-control" runat="server" TextMode="Password" onkeydown="return GetEnterCode('click','BtnSubmit');"/>
