<%@ page language="C#" autoeventwireup="true" inherits="manage_User_Userinfo, App_Web_3i5lpjsb" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <table class="table table-striped table-bordered">
                                ...
                                <asp:Repeater ID="Repeater2" runat="server">
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 35%; height: 26px;"><%#Eval("UserFace") %></td>
                                        </tr>
                                        <tr>
        ...
        <tr>
            <td colspan="4" class="text-center">
                ...
                <asp:Button ID="Button1" runat="server" Text="返回列表" OnClick="Button1_Click" class="btn btn-primary" />
            </td>
        </tr>
    </table>
</asp:Content>
