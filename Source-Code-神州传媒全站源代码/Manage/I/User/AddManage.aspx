<%@ page language="C#" autoeventwireup="true" inherits="ZoomLaManage.WebSite.Manage.User.AddManage, App_Web_0qcgjazw" title="编辑管理员" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="home">
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    <td class="text-right"><strong>管理员名：</strong></td>
                    <td>
                        <asp:TextBox ID="tbdName" Style="width: auto" CssClass="form-control" runat="server"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtAdminTrueName" runat="server" class="form-control pull-left" Style="width: auto"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbPwd" class="form-control pull-left" runat="server" TextMode="Password" Style="width: auto"></asp:TextBox>
                        <span class="pull-left" style="padding: 5px;">管理员密码字符数要在3-18之间</span>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbPwd1" runat="server" TextMode="Password" class="form-control pull-left" Style="width: auto"></asp:TextBox>
                ...
                <tr id="showmenu" runat="server">
                    <td class="title" colspan="2">
                        <asp:CheckBox Checked ID="adduser" AutoPostBack="true" runat="server"
                            Text="添加同名用户" OnCheckedChanged="adduser_CheckedChanged" /></td>
                </tr>
                <tr id="Tr1" runat="server" visible="true">
                    <td align="right">提示问题： </td>
                    <td colspan="3">
                        <asp:TextBox ID="tbQuestion" runat="server" Style="max-width: 220px" class="form-control pull-left"></asp:TextBox>
                ...
                <tr id="Tr2" runat="server" visible="true">
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="tbAnswer" runat="server" Style="max-width: 220px" class="form-control pull-left"></asp:TextBox>
                        <span style="color: red; float: left; padding-top: 8px;">*</span>
                ...
                <tr id="viewmail" runat="server" visible="true">
                    <td align="right">Email： </td>
                    <td colspan="3">
                        <asp:TextBox ID="tbEmail" runat="server" Style="max-width: 220px" class="form-control pull-left"></asp:TextBox>
                        <span style="color: red; float: left; padding-top: 8px;">*</span>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" ControlToValidate="tbEmail" Display="Dynamic" ErrorMessage="格式不正确" ValidationExpression="^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$" Visible="true"></asp:RegularExpressionValidator>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="tab-pane" id="messages">
            <table class="table table-striped table-bordered table-hover">
                <tr>
                    ...
                    <td valign="top">
                        <asp:CheckBox ID="CheckBox1" Checked runat="server" /></td>
                </tr>
                <tr>
