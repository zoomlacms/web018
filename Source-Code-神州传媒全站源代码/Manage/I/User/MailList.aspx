<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.User.MailList, App_Web_3i5lpjsb" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox class="form-control" ID="TxtContent" runat="server" Height="158px" TextMode="MultiLine" Width="476px"></asp:TextBox>
            </td>
        </tr>
        <tr>
