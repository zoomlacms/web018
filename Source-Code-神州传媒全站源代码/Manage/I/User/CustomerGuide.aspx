<%@ page language="C#" autoeventwireup="true" inherits="manage_User_CustomerGuide, App_Web_3i5lpjsb" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <ul>
      <li id="Li1">
        <div>
          <div class="guideexpand" onclick="Switch(this)"><%=lang.Get("m_CustomerGuide_insider")%></div>
          <div class="guide">
            <ul>
              <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../iServer/BiServer.aspx?num=-3&strTitle=" target="main_right"><%=lang.Get("m_ServerSite_problem")%></a> </li>
