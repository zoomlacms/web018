<%@ page language="C#" autoeventwireup="true" inherits="manage_User_CertificateAudit, App_Web_3i5lpjsb" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
  ...
  <table class="table table-striped table-bordered table-hover">
    ...
    <tr>
      <td> 关键字：
        ...
        <asp:Button ID="Button2" runat="server" Text="搜  索" class="btn btn-primary"  Style="height: 20px" Width="63px" OnClick="Button2_Click" /></td>
    </tr>
  </table>
  <div class="clearbox"> </div>
  <asp:GridView ID="Egv" runat="server" AutoGenerateColumns="False" class="table table-striped table-bordered table-hover" Width="100%" OnRowCommand="Lnk_Click">
    <Columns>
