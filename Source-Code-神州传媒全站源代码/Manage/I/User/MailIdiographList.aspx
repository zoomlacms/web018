<%@ page language="C#" autoeventwireup="true" inherits="manage_Qmail_MailIdiographList, App_Web_3i5lpjsb" enableviewstatemac="false" debug="true" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
  <div>
    <table class="table table-striped table-bordered table-hover">
      ...
      <tr class="tdbg">
        <td align="left"><input name="chk23" type="checkbox" ID="chk23" runat="server" onclick="selectAll(this)" class="checkbox" style="float:left;"/>&nbsp;&nbsp;全选
          &nbsp;&nbsp;&nbsp;&nbsp;
