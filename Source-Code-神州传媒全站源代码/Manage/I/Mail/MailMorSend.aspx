<%@ page language="C#" autoeventwireup="true" inherits="manage_Mail_MailMorSend, App_Web_lheibd2w" enableviewstatemac="false" validaterequest="false" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <table class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td style="text-align: left">
                <asp:TextBox ID="TxtContent" runat="server" class="form-control" TextMode="MultiLine" Rows="10" Columns="60"></asp:TextBox>
            </td>
