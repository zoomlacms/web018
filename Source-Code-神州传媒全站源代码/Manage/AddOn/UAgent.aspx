<%@ page language="C#" autoeventwireup="true" inherits="manage_Profile_UAgent, App_Web_yipn42em" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
...
<div class="r_navigation"><%=lang.Get("M_SpecContent_manage")%>&gt;&gt;<%=lang.Get("M_CommentManage_system")%>  &gt;&gt;<%=lang.Get("m_UAgent_Manage")%>&gt;&gt;<a href="AddUAgent.aspx" style="color:#ff0000;" title="添加自适配设备">[<%=lang.Get("m_UAgent_Add")%>]</a>&nbsp;<a href="../Config/SiteOption.aspx" title="开启设备自适应" style="color:#ff0000;">[开启设备自适配]</a></div>
