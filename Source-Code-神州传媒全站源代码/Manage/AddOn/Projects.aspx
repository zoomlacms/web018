<%@ page language="C#" autoeventwireup="true" inherits="manage_AddOn_Projects, App_Web_yipn42em" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<body>
  ...
  <%} %><span><%=lang.Get("m_Projects_manage")%></span>&nbsp;&gt;&gt;&nbsp;<%=lang.Get("m_Projects_crm")%></span>&nbsp;&nbsp;<span><a
