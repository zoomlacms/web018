<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Page.PageContent, App_Web_bwwdei1u" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
       ...
       <asp:Label ID="Label1" runat="server"></asp:Label></a>
        ...
        <div class="divline" style="padding-left: 5px; height: 35px;">
            <ul>
                ...
                <li><%=lang.Get("m_ContentManage_Ucity")%>： 
