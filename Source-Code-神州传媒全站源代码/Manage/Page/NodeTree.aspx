<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Page.NodeTree, App_Web_bwwdei1u" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<ul>
    <li id="Guide_top">
        <div id="Guide_toptext">
            <%= lang.Get("m_YellowPage_enterprise") %></div>
    </li>
    <li id="Guide_main">
        <div id="Guide_box">
            <div class="guideexpand" onclick="Switch(this)">
                <%= lang.Get("m_YellowPage_manage") %>
            </div>                    
        </div>
    </li>
 </ul>
