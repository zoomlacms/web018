<%@ page language="C#" autoeventwireup="true" inherits="manage_AddCRM_CustomerList, App_Web_4fcc11b0" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
  ...
  <%} %> <span><%=lang.Get("m_CustomerList_manage")%></span>&nbsp;&gt;&gt;&nbsp;<span><asp:Literal ID="liTitle" runat="server"></asp:Literal></span>&nbsp;&gt;&gt;&nbsp;<span><a href="CustomerList.aspx?usertype=0"><%=lang.Get("m_CustomerList_customer")%></a></span>&nbsp;&nbsp;<a href="CustomerManage.aspx?FieldName=Person_Add" style="color:red;">[<%=lang.Get("m_CustomerList_add")%>]</a>
        </div>
            ...
            <asp:Repeater ID="Repeater1" runat="server">
                <ItemTemplate>
                    <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'" ondblclick="getinfo(<%#Eval("Flow")%>);">
                        ...
                        <td align="center" style="height: 24px;">
                           <a href="CustomerManage.aspx?FieldName=Person_Add&menu=edit&id=<%#Eval("Flow") %>"><%=lang.Get("m_CustomerList_rework")%></a>　<a href="?menu=delete&code=<%#Eval("Code") %>" onclick="return confirm('你确定要将所有选择删除吗？');"><%=lang.Get("m_CustomerList_del")%></a></td>
                    </tr>
                </ItemTemplate>
            </asp:Repeater>
            <tr class="tdbg">
