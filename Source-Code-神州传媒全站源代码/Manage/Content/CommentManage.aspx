<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.CommentManage, App_Web_4sf4aaky" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<table border="0" cellpadding="0" cellspacing="0">
    <tr align="center">
        <td id="TabTitle0" class="titlemouseover" onclick="ShowTabss(0)"><%=lang.Get("M_CommentManage_allComment")%></td>
