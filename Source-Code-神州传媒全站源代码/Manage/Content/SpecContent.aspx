<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.SpecContent, App_Web_4sf4aaky" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
<div class="r_navigation">
    <span><%=lang.Get("M_SpecContent_manage")%></span> &gt;&gt; <span><a href="ContentManage.aspx"><%=lang.Get("M_SpecContent_content")%></a></span> &gt;&gt; <span><a href="SpecContent.aspx"><%=lang.Get("M_SpecContent_thematic")%></a></span> &gt;&gt; <span><asp:Label ID="Label1" runat="server" Text="专题名"></asp:Label></span>
</div>
</div>
<div class="h_27"></div>
