<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ContentRecycle, App_Web_4sf4aaky" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="r_navigation">
            ...
            </span><span><%=lang.Get("M_SpecContent_manage") %></span> &gt;&gt; <span><%=lang.Get("M_CommentManage_system") %></span> &gt;&gt; <span><a href="ContentManage.aspx"><%=lang.Get("M_SpecContent_content")%></a></span> &gt;&gt;<span><a href="ContentRecycle.aspx"><%=lang.Get("m_recycle")%></a></span>
        </div>
        </div>
