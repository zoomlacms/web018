<%@ page language="C#" debug="true" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ContentManage, App_Web_z2bfiz4n" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div class="r_navigation">
        <table style="float: right;margin-right: 20px;"><tr>
            ...
            <a onclick="opentitle('EditNode.aspx?NodeID=<%=CNodeID %>','配置本节点')"
                ...
                <%=lang.Get("m_ContentManage_deploy")%></a>
        </td></tr></table>
                    <%=lang.Get("m_ContentManage_manage")%> &gt;&gt; <span><a href="ContentManage.aspx">
    ...
    <div class="divline" id="toolbar1" style="padding-left: 5px; height: 25px;display:none; ">
        <ul>
            <li style="float: left;"><a href="ContentManage.aspx?NodeID=<%=Request.QueryString["NodeID"] %>">
                <%=lang.Get("m_ContentManage_list")%></a> <a href="ContentManage.aspx?NodeID=<%=Request.QueryString["NodeID"] %>&flag=Elite">
                <%=lang.Get("m_ContentManage_recommend")%></a> 
                 <a href="javascript:void(0)"> <%=lang.Get("m_ContentManage_sort") %>：</a> 
            </li>
            ...
            <li style="float: left; margin-left:10px;">
              ...
              <li style="float: left; margin-left:10px;">  <%=lang.Get("m_ContentManage_Ucity")%>：
 <select runat="server" id="selprovince" name="selprovince" onchange="javascript:area()"></select>
    ...
    <div class="divline" id="toolbar2" style="padding-left: 5px; margin-top:5px;">
        <table width="99%">
            <tr>
                <td>
                    <b onclick="OpenAddContent()"><%=lang.Get("m_ContentManage_operate")%>：</b>
                ...
                <td align="right">
                 ...
                 <td  align="right">
                     <%=lang.Get("m_ContentManage_acount")%>:<asp:Label ID="WZS" runat="server"></asp:Label><%=lang.Get("m_ContentManage_hits")%>:<asp:Label ID="DJS" runat="server"></asp:Label>
                </td> 
            </tr>
        </table>
    </div>
