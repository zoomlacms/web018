<%@ page language="C#" autoeventwireup="true" inherits="manage_Content_HitsList, App_Web_4sf4aaky" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html >
<head runat="server">
...
<div style="height:29px;"></div>
    <div style=" margin-left:30px; float:left;"> <%=lang.Get("M_HitsList_title")%>： <asp:TextBox ID="txtTitle" ToolTip="支持模糊查询" runat="server" Width="100px" CssClass="l_input"></asp:TextBox>&nbsp;&nbsp;&nbsp;
            <%=lang.Get("M_HitsList_month")%>：<asp:TextBox ID="txtTime" runat="server" Width="100px" CssClass="l_input" onclick="WdatePicker({ dateFmt: 'yyyy-MM' });"   ></asp:TextBox>
