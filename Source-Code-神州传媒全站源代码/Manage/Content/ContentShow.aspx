<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.ContentShow, App_Web_ourdrs32" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<span>后台管理</span> &gt;&gt; <span><a href="ContentManage.aspx">内容管理</a></span>&gt;&gt;
    <span style="float: right;padding-right: 10px;">
        ...
        <%=GetOper()%>
        <a onclick="opentitle('EditNode.aspx?NodeID=<%=GetNodeID()%>','配置本节点')" href="javascript:void(0);" title="配置本节点"><%=lang.Get("m_ContentManage_deploy")%></a></span>
