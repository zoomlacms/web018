<%@ page language="C#" autoeventwireup="true" inherits="Manage_Content_SohuChatManage, App_Web_4sf4aaky" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<form id="form1" runat="server">
    <div id="nav_box"><div class="r_navigation">
            <%=lang.Get("m_ContentManage_manage")%> &gt;&gt; <span><a href="CommentManage.aspx">评论管理</a></span> &gt;&gt; <span>畅言评论管理<a href="javascript:disDiv(1);void(0);" style="color: green; margin-left: 5px; font-size: 13px;" id="configHref">[修改配置]</a> 
