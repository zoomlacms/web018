<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="ZoomLa.WebSite.Manage.Content.AddContent, App_Web_4sf4aaky" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<span style="float: right;padding-right: 10px;">
    ...
    <%=GetOper()%>
    <a onclick="opentitle('EditNode.aspx?NodeID=<%=this.NodeID %>','配置本节点')" href="javascript:void(0);" title="配置本节点"><%=lang.Get("m_ContentManage_deploy")%></a>
</span> 
