<%@ page language="C#" autoeventwireup="true" enableeventvalidation="false" inherits="ZoomLa.WebSite.Manage.Content.CreateHtmlContent, App_Web_4sf4aaky" enableviewstatemac="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
-->    <div class="clearbox"></div>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" class="border" align="center" id="crt1" name="crt1">
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td class="bqright">
                <asp:TextBox ID="txtNewsCount" Style="margin-left: 12px;" class="l_input" runat="server"></asp:TextBox><%=lang.Get("M_CreateHtmlContent_piece")%>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            ...
            <td class="bqright">
                <%=lang.Get("M_CreateHtmlContent_from")%><asp:TextBox ID="txtStartDate" class="l_input" runat="server" onclick="WdatePicker();" /><%=lang.Get("M_CreateHtmlContent_to")%>
        ...
        <tr class="tdbg" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'">
            <td align="right" style="height: 24px">&nbsp;<%=lang.Get("M_CreateHtmlContent_personnelSystem") %>：
            </td>
        ...
        <tr class="tdbg">
            <td align="right" style="height: 24px">&nbsp;<%=lang.Get("M_CreateHtmlContent_publishAll")%>：
            </td>
