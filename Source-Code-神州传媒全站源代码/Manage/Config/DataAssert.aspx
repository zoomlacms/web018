<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_DataAssert_, App_Web_xukcilvn" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>表内容批处理</title>
...
<form id="form1" runat="server">
  ...
  <%} %>后台管理&gt;&gt;扩展功能&gt;&gt;<a href="RunSql.aspx">开发中心</a>&gt;&gt;表内容批处理</div>
