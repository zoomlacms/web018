<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_DataSearch, App_Web_nhaj5l4j" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <title>全库搜索</title>
...
<form id="form1" runat="server">
  ...
  <%} %>后台管理&gt;&gt;扩展功能&gt;&gt;<a href="RunSql.aspx">开发中心</a>&gt;&gt;全库搜索</div>
...
<table style="width: 100%;" cellpadding="2" cellspacing="1" class="border">
   <tr class="tdbg">
     ...
     <td><asp:TextBox ID="TextBox1" runat="server" Width="200px" CssClass="x_input" 
        ...
        <asp:Button ID="Button2" runat="server" Text="搜索"  CssClass="C_input" onclick="Button1_Click"/></td>
   </tr>
</table>
