<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_EmptyData, App_Web_nhaj5l4j" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
<title>清空测试数据</title>
...
<div class="r_navigation"><%if(GetOpenHelp.IsopenHelp()=="1")
  ...
  <%} %>后台管理&gt;&gt;扩展功能&gt;&gt;<a href="RunSql.aspx">开发中心</a>&gt;&gt;清空测试数据</div>
