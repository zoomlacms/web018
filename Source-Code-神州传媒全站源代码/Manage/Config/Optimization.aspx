<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_Optimization, App_Web_nhaj5l4j" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html >
<html>
<head runat="server">
    <title>数据库优化</title>
...
<body>
  ...
  <%} %><a href="/manage/">后台管理</a> &gt;&gt;扩展功能&gt;&gt;<a href="DatalistProfile.aspx">开发中心</a>  &gt;&gt;<a href="DatalistProfile.aspx">数据库优化</a></div>
