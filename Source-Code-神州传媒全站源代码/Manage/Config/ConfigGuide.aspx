<%@ page language="C#" autoeventwireup="true" inherits="manage_Config_ConfigGuide, App_Web_nhaj5l4j" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
        ...
        <ul>
            ...
            <li id="Guide_main">
                <div id="Guide_box">
                    ...
                    <div class="guide">
                        <ul>
                            <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../I/Config/SiteInfo.aspx" target="main_right"><%=lang.Get("m_ConfigGuide_web")%></a></li>
                            <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../I/Config/SiteOption.aspx" target="main_right"><%=lang.Get("m_ConfigGuide_webdata")%></a></li>
