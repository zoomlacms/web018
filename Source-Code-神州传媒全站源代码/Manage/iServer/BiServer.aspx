<%@ page language="C#" autoeventwireup="true" inherits="manage_iServer_BiServer, App_Web_ilrmjgzf" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
  ...
  <%} %>
        <span><%=lang.Get("m_BiServer_manage")%></span>&gt;&gt;<span><a href="BiServer.aspx"><%=lang.Get("m_BiServer_qa")%></a></span>&nbsp;<span style="color:red;"><a href="AddQuestionRecord.aspx" style=" color:Red;">[添加问题记录]</a></span>
    </div>
    <div class="clearbox">
    </div>
    <table width="100%">
                    ...
                    <td colspan="2" style="text-align: center">
                        <table width="100%" cellpadding="2" cellspacing="1" class="border" style="background-color: white;">
                            ...
                            <tr align="left" class="tdbg" ondblclick="javascript:window.location.href='BselectiServer.aspx?num=-3&strTitle='" onmouseover="this.className='tdbgmouseover'" onmouseout="this.className='tdbg'"
                                                class="tdbg">
                                <td width="100" align="right"><a href="BselectiServer.aspx?num=-3&strTitle="><%=lang.Get("m_BiServer_total")%></a>：</td>
                                <td>
