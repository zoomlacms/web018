<%@ page language="C#" autoeventwireup="true" inherits="manage_Microblog_LivingManage, App_Web_h0ze5h3z" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
<html>
<head runat="server">
    <title> 直播室管理</title> 
...
<form id="form1" runat="server">
 <div class="r_navigation divline" style="height:25px;">
 <%if(GetOpenHelp.IsopenHelp()=="1")
    { %>
      <div id="help"> <a onclick="help_show('28')" title="帮助"></a></div>
  <%} %> 
     <div style="float:left;">
     后台管理 &gt;&gt; 用户管理 &gt;&gt; <a href="LivingManage.aspx">直播室管理</a> 
         </div>
     <table  cellpadding="2" border="0" cellspacing="1" style="background:#fff;float:left;margin-left:10px;" class="l_input"><tr ><td>
         <asp:TextBox ID="TxtLogName" runat="server" BorderColor="#fff" CssClass="l_inpnon"> 主题</asp:TextBox><asp:Button ID="BntSearch" runat="server" Text="" OnClick="BntSearch_Click" class="C_sch" /></td></tr></table>
    </div>
           ...
           <asp:TemplateField HeaderText="推荐">
            ...
            <asp:TemplateField HeaderText="操作">
                ...
                <ItemTemplate>
                    ...
                    |
                    <asp:LinkButton ID="LinkButton5" runat="server" CommandName='<%#GetStatus(Eval("lcheck").ToString())%>' CommandArgument='<%# Eval("lid") %>'><%#Status1(Eval("lcheck").ToString())%></asp:LinkButton>
                    |
