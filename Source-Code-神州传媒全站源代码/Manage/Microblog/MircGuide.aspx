<%@ page language="C#" autoeventwireup="true" inherits="manage_Microblog_MircGuide, App_Web_h0ze5h3z" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
            ...
            <div id="Div3">
                ...
                <ul>                        
                    ...
                    <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../Microblog/ContentManage.aspx" target="main_right"><%=lang.Get("m_MircGuide_groadcast")%></a></li>
                     <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../Microblog/LivingManage.aspx" target="main_right">
                         <%= lang.Get("m_MircGuide_liveroomgmt") %>   </a></li>
                </ul>
                </div>
            </div>
        </li>
