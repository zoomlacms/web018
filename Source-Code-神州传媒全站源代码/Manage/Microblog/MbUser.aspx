<%@ page language="C#" autoeventwireup="true" inherits="manage_Microblog_MbUser, App_Web_h0ze5h3z" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>微博用户管理</title>
...
<table width="100%" cellpadding="2" cellspacing="1" class="border">
    <tr>
        <td class="tdbg">
            ...
            <table border="0"  style="background:#fff;float:left;margin-left:10px;" class="l_input"><tr><td>
