<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.login, App_Web_b2if4w0p" enableviewstatemac="false" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div style="margin-top:15em;">
    <ul class=" list-unstyled text-center center-block">
        ...
        <li style="margin-top:6em;"><asp:TextBox ID="TxtUserName" runat="server" size="20" TabIndex="1" class="form-control input-control" autocomplete="off" 
            placeholder="帐户" onkeydown="return GetEnterCode('focus','TxtPassword');"/></li>
        <li>
            <asp:TextBox ID="TxtPassword" runat="server" TextMode="Password" MaxLength="18" TabIndex="2" 
        ...
        <li id="safecode" runat="server"><asp:TextBox ID="TxtAdminValidateCode" TabIndex="3"  runat="server" MaxLength="6" class="form-control input-control" 
            size="20" /></li>
        <li id="CodeLi" runat="server" visible="false" style="margin-bottom:0;">
            <div class="form-group has-feedback" style="position:relative;display:inline-table">
              <asp:TextBox ID="TxtValidateCode" runat="server" class="form-control input-control" Width="325" TabIndex="4" autocomplete="off" onkeyup="checkCode(this);" onkeydown="return GetEnterCode('click','IbtnEnter');"/>
        ...
        <li>
            <asp:Button runat="server" ID="IbtnEnter" CssClass="btn btn-info input-control" TabIndex="5" Text="立即登录" OnClick="IbtnEnter_Click"/>
        </li>
        <li> 
