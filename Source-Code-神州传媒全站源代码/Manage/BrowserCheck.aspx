<%@ page language="C#" autoeventwireup="true" inherits="manage_SystemCheck_, App_Web_b2if4w0p" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>浏览器检测</title>
...
<%--    <tr><td>窗体数</td><td id="vwind">不支持</td></tr>--%>
</table>
<%--<div class="info_url">
    <a href="http://www.zoomla.cn/help/web/1414.shtml" title="设置Cookie" target="_blank">如何设置Cookie</a>&nbsp;&nbsp;
    <a href="http://www.zoomla.cn/help/web/1413.shtml" title="设置脚本" target="_blank">如何设置网页脚本</a>&nbsp;&nbsp;
    <a href="Common/SystemFinger.aspx" title="服务器信息总览" target="_parent">服务器信息总览>></a>
    </div>--%>
</div>
