<%@ page language="C#" autoeventwireup="true" inherits="manage_Question_TrainGuide, App_Web_usklqwfv" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <div id="Guide_box">
                    ...
                    <div class="guide">
                        <ul>
                            ...
                            <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'">
                                <a href="../AddCRM/CustomerList.aspx?usertype=0" target="main_right">
                                    <%=lang.Get("m_TrainGuide_manage")%></a></li>
                            <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'">
                                 <a href="../iServer/BselectiServer.aspx?num=-3&strTitle=" target="main_right">
                                    <%=lang.Get("m_TrainGuide_insider")%></a></li>
                            <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'">
                                <a href="../User/Message.aspx" target="main_right">
