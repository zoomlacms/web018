<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa_WebSite_Manages_Worktable, App_Web_xcpn3r14" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <div class="panel-body">
                <table id="ShortCutTable" style="width:550px;" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td class="text-center"><a href="../I/Content/ModelManage.aspx?ModelType=1"><img src="../../App_Themes/AdminDefaultTheme/images/System2.png" alt="内容模型管理" /></a></td>
                    ...
                    <tr>
                        <td class="text-center"><a href="../I/Config/SiteInfo.aspx" target="_blank"><%=lang.LF("网站配置")%></a></td>
                        <td class="text-center"><a href="../I/Content/ModelManage.aspx" target="_blank"><%=lang.LF("内容模型管理")%></a></td>
                        <td class="text-center"><a href="../I/Content/NodeManage.aspx" target="_blank"><%=lang.LF("节点设置")%></a></td>
                        <td class="text-center"><a href="../I/Template/LabelManage.aspx" target="_blank"><%=lang.LF("标签设置")%></a></td>
                        <td class="text-center"><a href="../I/Template/TemplateSet.aspx" target="_blank"><%=lang.LF("模板设置")%></a></td>
                        <td class="text-center"><a href="../I/User/AdminManage.aspx" target="_blank"><%=lang.LF("安全设定")%></a></td>
                        <td class="text-center"><a href="../I/Content/ContentManage.aspx" target="_blank"><%=lang.LF("内容管理")%></a></td>
                    </tr>
                </table>
            </div>
        </div>
                                ...
                                <tbody style="border: 1;" id="calendar" name="calendar" class="text-center">
                                    <script type="text/javascript">
                                        for (var intWeeks = 0; intWeeks < 6; intWeeks++) {
                                            ...
                                            for (var intDays = 0; intDays < days.length; intDays++) document.write("<TD style='padding:6px;' class=\"CalendarTD\" onMouseover=\"buttonOver();\" onMouseOut=\"buttonOut();\"></TD>");
                                            document.write("</TR>");
                                        }
                                    </script>
                                </tbody>
            ...
            <tr>
                ...
                <td style="padding-left:1px;vertical-align:top;">
                    <table class="table table-striped table-bordered table-hover" style="margin-bottom:0px;">
                        <tbody>
                            <tr class="gridtitle" style="text-align:center;">
                                <td style="width:3%;">ID </td>
                                <td style="width:10%;"><%=lang.Get("m_Worktables_name")%></td>
                                <td style="width:7%;"><%=lang.Get("m_Worktables_type")%></td>
                                <td style="width:5%;"><%=lang.Get("m_Worktables_price")%></td>
                                <td style="width:7%;"><%=lang.Get("m_Worktables_manager")%></td>
                                <td style="width:6%;"><%=lang.Get("m_Worktables_rate")%></td>
                                <td style="width:12%;" ><%=lang.Get("m_Worktables_time")%></td>
                            </tr>
                            <asp:Repeater ID="Repeater1" runat="server" Visible="false">
                                <ItemTemplate>
                                    <tr id='<%#Eval("ID") %>' title="双击查看详情" ondblclick="getinfo(this.id);">
                                        ...
                                        <td><%# GetManageGroup(Eval("Leader","{0}")) == 1 ? Eval("Price", "￥{0}.00") : "******"%></td>
                                        <td><a href="../AddCRM/ViewCustomer.aspx?FieldName=Person_Add&id=3"><%#GetLeader(Eval("Leader","{0}"))%></a></td>
                                        <td>
                                            <a href='<%#Eval("ID","../AddOn/ProjectsProcesses.aspx?ID={0}") %>'>
