<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.index, App_Web_b2if4w0p" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html lang="zh">
                        ...
                        <div id="Menu_3" style="display: none;">
                            <ul>
                                ...
                                <%}
                                    ...
                                    {  %>
                                <li><a href="javascript:ShowMain('Microblog/MircGuide.aspx','Microblog/MbUser.aspx')" onclick="ShowHideLayer(7,3)" style="font-weight: bold">
                                    <%--微博管理--%><%= lang.LF("微博管理")%></a> </li>
                                <%}
                        ...
                        <div id="Menu_7" style="width: 100%; display: none;">
                            <ul>
                                <li><a href="javascript:ShowMain('Microblog/MircGuide.aspx','Microblog/MbUser.aspx')">
                                    <%= lang.LF("微博用户") %></a></li>
                                <li><a href="javascript:ShowMain('Microblog/MircGuide.aspx','Microblog/ContentManage.aspx')">
                                    <%= lang.LF("微博广播") %></a> </li>
                                <li><a href="javascript:ShowMain('Microblog/MircGuide.aspx','Microblog/LivingManage.aspx')">
                                    <%= lang.LF("直播室管理") %></a></li>
                                <li><a href="javascript:ShowMain('Microblog/MircGuide.aspx','Microblog/ThemeManage.aspx')">
                                    <%= lang.LF("话题管理") %></a></li>
                                <li><a href="javascript:ShowMain('Microblog/MircGuide.aspx','Microblog/AddTheme.aspx')">
                                    <%= lang.LF("添加话题") %></a> </li>
                                <li><a href="javascript:ShowMain('Microblog/MircGuide.aspx','Microblog/ClassManage.aspx')">
                                    <%= lang.LF("分类管理") %></a></li>
                                <li><a href="javascript:ShowMain('Microblog/MircGuide.aspx','Microblog/AddClass.aspx')">
                                    <%= lang.LF("添加分类") %></a></li>
                        ...
                        <div id="Menu_9" style="width: 100%; display: none;">
                            <ul>
                                <%
                                  ...
                                  { %>
                                <li><a href="javascript:ShowMain('AddOn/DataGuide.aspx','Config/DatalistProfile.aspx')">
                                ...
                                <%}
                                  ...
                                  { %>
                                <li><a href="javascript:ShowMain('AddOn/DownGuide.aspx','AddOn/Download.aspx')">
                                    <%--客户端--%><%= lang.LF("客户端")%></a></li>
                                <%} 
                                 if (ShowPlubArr[7].ToString() == "1")
                                  { %>
			                    <li><a href="javascript:ShowMain('WeiXin/wxApiGuide.aspx','WeiXin/wxApi.aspx')">
                                ...
                                <li><a href="javascript:void(0);" onclick="ShowMain('Pub/PubGuide.aspx','Pub/pubmanage.aspx')"
                                    onmouseover="showmenu(event,'<div class=menuitems><a href=\'javascript:void(0);\' onclick=ShowMain(\'Iplook/IplookGuide.aspx\',\'Iplook/IPManage.aspx\') ><%--IP识别系统--%><%= lang.LF("IP识别系统")%></a></div><div class=menuitems><a href=\'javascript:void(0);\' onclick=ShowMain(\'Search/SearchGuide.aspx\',\'Search/DirectoryManage.aspx\')><%--全文检索--%><%= lang.LF("全文检索")%></a></div><div class=menuitems><a href=\'javascript:void(0);\' onclick=ShowMain(\'AddOn/FileseeGuide.aspx\',\'AddOn/FileseeManage.aspx\')><%--文件比较--%><%= lang.LF("文件比较")%></a></div>')">
