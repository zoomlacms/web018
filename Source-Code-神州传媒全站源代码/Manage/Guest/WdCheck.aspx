<%@ page language="C#" autoeventwireup="true" inherits="manage_Guest_WdCheck, App_Web_nswe1zzb" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    <form id="form1" runat="server">
        <div class="r_navigation" style="position:relative;float:left;width:97%">
            ...
            <%} %>
            <%=lang.Get("M_SpecContent_manage")%> &gt;&gt;<%=lang.Get("m_mesmanage")%> &gt;&gt;<%=lang.Get("M_Guest_WenDaClass")%>
        ...
        <div class="borders">
            <table border="0" cellpadding="0" cellspacing="0">
                <tr align="center">
                    ...
                    <td id="TabTitle1" class="tabtitle" onclick="ShowTabss(1)"><a href="?type=1&id=1&QueType=<%=Request["QueType"] %>"><%=lang.Get("m_ContentManage_wait")%></a></td>
                    <td id="TabTitle2" class="tabtitle" onclick="ShowTabss(2)"><a href="?type=2&id=2&QueType=<%=Request["QueType"] %>"><%=lang.Get("m_ContentManage_complete")%></a></td>
