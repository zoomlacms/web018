<%@ page language="C#" autoeventwireup="true" inherits="manage_Guest_Asklist, App_Web_nswe1zzb" enableviewstatemac="false" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="r_navigation">
            ...
            <%} %>
            <%=lang.Get("M_SpecContent_manage")%> &gt;&gt;<a href="GuestCateMana.aspx">百科问答</a> &gt;&gt;<a href="WdCheck.aspx">问答管理</a>&gt;&gt;信息管理
        </div>
        <div class="clearbox">
        </div>
