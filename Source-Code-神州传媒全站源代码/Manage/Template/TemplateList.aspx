<%@ page language="C#" autoeventwireup="true" enableviewstatemac="false" inherits="ZoomLa.WebSite.Manage.Template.TemplateList, App_Web_erkfduyt" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
{ 
  //  window.dialogArguments.document.getElementById('<%= FilePathInput %>').value = document.getElementById('FileName').value;
    ...
    window.dialogArguments.document.getElementById('<%=Request.QueryString["OpenerText"] %>').value= document.getElementById('FileName').value;
}
</script>
</body>
</html>
