<%@ page language="C#" autoeventwireup="true" inherits="manage_Component_Component, App_Web_qg35bjy0" responseencoding="utf-8" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
     ...
     <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" >
        ...
        <tr class="tdbg" style="cursor:pointer;" align="center" onmouseover="this.className='tdbgmouseover '" onmouseout="this.className='tdbg '" id="<%# Eval("Id") %>"  ondblclick="window.location.href='AddEditComponent.aspx?Id=<%# Eval("Id") %>'"  >
              ...
              <asp:TextBox ID="txtID" Text='<%# Eval("Id")%>' runat="server" style="display:none;"></asp:TextBox>
                <asp:LinkButton ID="LinkButton4" runat="server" CommandName="Edit" CommandArgument='<%# Eval("Id")%>'>修改</asp:LinkButton>
                |
