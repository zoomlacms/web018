<%@ page language="C#" autoeventwireup="true" inherits="manage_User_UserGuide, App_Web_2mm1u3mc" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
...
<script type="text/javascript">
    ...
    function search() {
        ...
        window.open('UserManage.aspx?lblkey=' + LabelName, "main_right");
    }
    function cls() {
  ...
  <div id="Div1">
    ...
    <table  cellpadding="2" cellspacing="1" class="l_input" style="background:#fff;"><tr><td> <asp:TextBox ID="Lname" runat="server" Width="155px" Height="20px"  class="l_inpnon" Text="会员名" onfocus="cls()" onblur="res()" onkeyup="if (event.keyCode==13) {search();}"></asp:TextBox></td><td><input type="button" onclick="search()" value=" " class="C_sch" Style=""/></td></tr></table></div>
            <ul>
              ...
              <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../APP/Suppliers.aspx" target="main_right">社会化登陆</a></li> 
              <li class="guideli" onmouseover="this.className='guidelihover'" onmouseout="this.className='guideli'"><a href="../APP/Ucenter.aspx" target="main_right">跨域网站接入</a></li> 
