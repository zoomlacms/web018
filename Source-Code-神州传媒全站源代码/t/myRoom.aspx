<%@ page language="C#" autoeventwireup="true" inherits="t_myRoom, App_Web_204teml0" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
    ...
    <div id="blk4" class="blk" style="display: none;">
        ...
        <div class="main">
            ...
            <ul style="margin: 5px;"> 请输入音乐地址:  </ul>
            <ul style="text-align: center; text-align: center">
                <asp:TextBox ID="musictxt" runat="server" Width="280px"></asp:TextBox>
                <asp:Button ID="Button4" runat="server" Width="80px" OnClientClick="addmusic();return false;" Text="确定" />
                <br />
            </ul>
            <ul style="text-align: center; text-align: center">
                <br />
