<%@ page language="C#" autoeventwireup="true" inherits="t_HisRoom, App_Web_204teml0" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
...
<div id="warp">
	...
	<div id="warp_r">
		...
		<div class="r_ni">
			...
			<div class="ni_hd">
				<div class="ni_hd_m">
					<span >发布纸条&nbsp; &nbsp;请选择向谁提问</span> <span >
						<asp:DropDownList runat="server" ID="ddlguest">
						</asp:DropDownList>
					</span>
				</div>
				<div class="ni_hd_n">
		...
		<div id="r_k_main">
			<div class="news_li">
				<span><b>含有"<asp:Literal ID="liTheme" runat="server"></asp:Literal>"主题的直播
					<%--(<asp:Literal ID="liCondi" runat="server"></asp:Literal>条)--%>
				</b></span>
				<ul id="myTab1">
					<li class="active" onclick="nTabs(this,0);">直播主持</li>
			...
			<div id="myTab1_Content1" style="height: 600px; display:none;overflow: auto;">
			...
			<div id="myTab1_Content2" style="height: 600px;display:none; overflow: auto;">
				...
				<%--<div id="PageList2" runat="server"></div>	--%>
			</div>
			<div class="clear">
			</div>
			<div class="up">
				<img alt="" src="../App_Themes/Microblog/images/up.jpg" /><a href="#">返回顶部</a>
			</div>
		</div> 
<div id="r_k_end"> </div>
	</div>
