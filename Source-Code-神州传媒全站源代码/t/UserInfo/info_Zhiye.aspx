<%@ page language="C#" autoeventwireup="true" inherits="Weibo_UserInfo_info_Zhiye, App_Web_y1ohhkq2" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>

<!DOCTYPE HTML>
<html>
<head id="Head1" runat="server">
<title>欢迎访问<%Call.Label("{$SiteName/}");%>微博-个人职业信息</title>
...
<body>
    ...
    <div id="warp">
        ...
        <div id="zhu_content">
            ...
            <div id="zhu_hang">
                <span>以下信息将显示<b><a href="#">在你的个人资料页</a></b>,方便大家了解你 。</span><b><a href="info_Jiben.aspx">基本信息</a></b>
                    &nbsp;&nbsp;&nbsp;|<b><a href="info_Jiaoyu.aspx">教育信息</a></b>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;职业信息
            </div>
            <div class="bitian">
            ...
            <div class="bitian1">
                所在地：
                <asp:DropDownList ID="province" runat="server" CssClass="select01" AutoPostBack="true" 
                ...
                <br />
                <span>*</span>单位名称：
                <asp:TextBox ID="txtDanwei" runat="server" CssClass="yonghu" Text="" />
                <br />
                <br />
                工作时间：
                ...
                <br />
                部门/职位：<asp:TextBox 
                    ID="txtBumen" runat="server" TextMode="MultiLine" CssClass="yonghu" 
