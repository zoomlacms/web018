<%@ page language="C#" autoeventwireup="true" inherits="Guest_AskStar, App_Web_r2tdfcfg" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE html>
...
<div id="main" class="rg_inout">
    <h1>
    <span style="float:left; width: 397px;" >您的位置：<a href="/">网站首页</a>>><a href="Default.aspx">问答首页</a>>><a href="Classification.aspx" >知识专题</a></span>
    </h1>
    <div class="clear"></div>
