<%@ page language="C#" autoeventwireup="true" validaterequest="false" inherits="BBS_GuestShow, App_Web_iethcyfp" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head>
...
<div id="main">
  ...
  <div class="s_body">
    ...
    <asp:HiddenField ID="HdnGID" runat="server" /></td></tr>
      <tr><td width="10%" align="right">验证码：</td><td align="left"> <asp:Image ID="Image1" runat="server" ImageUrl="~/Common/ValidateCode.aspx" Height="20px"
    ToolTip="点击刷新验证码" Style="cursor: pointer;line-height:23px; border: 0; vertical-align: middle;" onclick="this.src='../../Common/ValidateCode.aspx?t='+Math.random()" />
      ...
      <tr><td colspan="2" align="center">    <asp:Button ID="Button1" cssclass="i_bottom" runat="server" Text="发表回复" OnClick="Button1_Click" OnClientClick="return CheckDirty()" style=" margin-top:10px;  "/></td></tr>
      </table> 
