<%@ page language="C#" autoeventwireup="true" inherits="Common_PrintPage, App_Web_wgk4dvzs" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div id="content" class="content con" style="margin-top:10px;">
    <div class="cont-wrap" id="contentTr" style="line-height:24px;">
        ...
        <div id="prog_Div" class="curDrag" style="width:300px;cursor:move;"></div>
    </div>
</div><!--endprint-->
