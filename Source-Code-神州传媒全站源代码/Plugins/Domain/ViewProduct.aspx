<%@ page language="C#" autoeventwireup="true" inherits="Plugins_Domain_ViewProduct, App_Web_sijlj2mg" masterpagefile="~/Manage/Site/OptionMaster.master" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                ...
                <Columns>
                     <asp:BoundField HeaderText="序号" DataField="ID" ReadOnly="true" />
                       <asp:TemplateField HeaderText="品名">
                        <ItemTemplate>
                           <a href="/Shop.aspx?ItemID=<%#Eval("ID") %>" target="_viewDetail"><%#Eval("ProName") %></a>
                        </ItemTemplate>
                    </asp:TemplateField>
