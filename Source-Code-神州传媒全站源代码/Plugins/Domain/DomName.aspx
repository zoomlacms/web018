<%@ page language="C#" autoeventwireup="true" inherits="Manage_Site_DomName, App_Web_sijlj2mg" masterpagefile="~/Manage/Site/SiteMaster2.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div id="site_main">
    ...
    <div id="rightDiv">
    <div id="tab1">
        <iframe id="tab1Frame" onload="frameInit(this,'tab1Frame');"  src="/Site/Domain.aspx?remote=true" style="width:98%;" frameborder=0 scrolling=yes></iframe>
    </div>
