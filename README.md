...
- [Zoomla!逐浪CMS卓越出品](#zoomla逐浪cms卓越出品)
  - [逐浪官方开源精品全站项目018：神州传媒全套模板](#逐浪官方开源精品全站项目018神州传媒全套模板)
  - [本项目介绍](#本项目介绍)
- [开放性说明](#开放性说明)
  - [使用说明](#使用说明)
- [接口文档](#接口文档)
...
这是一个综合在线咨询的全站系统，移动优先，全面支持响应式，其特征包括：
- 服务端基于Zoomla!逐浪CMS开发
- 前端web呈现基于Boostrap 
...
```
- 10.在部分电脑上部署可能会出现无样式，如无样式请将web.config中`staticContent`中添加`<remove fileExtension=".mp4" />`
